...
export declare enum Autorename {
    disabled = "disabled",
    flexible = "flexible",
    strict = "strict"
}
export declare type ModeValues = keyof typeof Mode;
export declare type SourceValues = keyof typeof Source;
export declare type AutorenameValues = keyof typeof Autorename;
