 ...
 */ function U(t = "Unexpected state") {
    ...
    const e = `FIRESTORE (${k}) INTERNAL ASSERTION FAILED: ` + t;
 ...
 */ class H {
    ...
    start(t, e) {
        ...
        t.enqueueRetryable((() => e(N.UNAUTHENTICATED)));
    }
    shutdown() {}
}
...
class Y {
    ...
    start(t, e) {
        ...
        // This promise is re-created after each change.
                let i = new G;
        this.o = () => {
            this.i++, this.currentUser = this.u(), i.resolve(), i = new G, t.enqueueRetryable((() => s(this.currentUser)));
        };
        const r = () => {
            const e = i;
        ...
        setTimeout((() => {
            if (!this.auth) {
                ...
                M("FirebaseAuthCredentialsProvider", "Auth not yet detected"), i.resolve(), i = new G);
            }
        }), 0), r();
    }
    getToken() {
    ...
    u() {
        ...
        return q(null === t || "string" == typeof t), new N(t);
    }
}
 ...
 */ class X {
    constructor(t, e, n) {
        this.type = "FirstParty", this.user = N.FIRST_PARTY, this.headers = new Map, this.headers.set("X-Goog-AuthUser", e);
 ...
 */ class Z {
    ...
    start(t, e) {
        ...
        t.enqueueRetryable((() => e(N.FIRST_PARTY)));
    }
    shutdown() {}
    invalidateToken() {}
}
...
class et {
    ...
    start(t, e) {
        this.o = n => {
            t.enqueueRetryable((() => (t => (null != t.error && M("FirebaseAppCheckTokenProvider", `Error getting App Check token; using placeholder token instead. Error: ${t.error.message}`), 
            e(t.token)))(n)));
        };
        const n = t => {
    ...
    getToken() {
        ...
        new tt(t.token)) : null)) : Promise.resolve(null);
    }
    invalidateToken() {
        this.forceRefresh = !0;
    }
...
class ut {
     ...
     */
    e) {
        if (this.seconds = t, this.nanoseconds = e, e < 0) throw new W(Q.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (e >= 1e9) throw new W(Q.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (t < -62135596800) throw new W(Q.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
        // This will break in the year 10,000.
                if (t >= 253402300800) throw new W(Q.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
    }
    /**
...
class wt {
    ...
    isEqual(t) {
        return 0 === wt.comparator(this, t);
    }
    child(t) {
        const e = this.segments.slice(this.offset, this.limit());
        return t instanceof wt ? t.forEach((t => {
            e.push(t);
 ...
 */ class _t extends wt {
     ...
     */    static fromString(...t) {
        ...
        const e = [];
        for (const n of t) {
            if (n.indexOf("//") >= 0) throw new W(Q.INVALID_ARGUMENT, `Invalid segment (${n}). Paths must not contain // in them.`);
 ...
 */ class gt extends wt {
     ...
     */    static fromServerFormat(t) {
        ...
        let n = "", s = 0;
        const i = () => {
            if (0 === n.length) throw new W(Q.INVALID_ARGUMENT, `Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`);
            e.push(n), n = "";
        };
        let r = !1;
        for (;s < t.length; ) {
            const e = t[s];
            if ("\\" === e) {
                if (s + 1 === t.length) throw new W(Q.INVALID_ARGUMENT, "Path has trailing escape character: " + t);
                const e = t[s + 1];
                if ("\\" !== e && "." !== e && "`" !== e) throw new W(Q.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                n += e, s += 2;
            } else "`" === e ? (r = !r, s++) : "." !== e || r ? (n += e, s++) : (i(), s++);
        }
        if (i(), r) throw new W(Q.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
        return new gt(e);
    }
    static emptyPath() {
        return new gt([]);
    ...
    switch (n) {
      ...
      case 10 /* ObjectValue */ :
        return function(t, e) {
            ...
            for (const t in n) if (n.hasOwnProperty(t) && (void 0 === s[t] || !xt(n[t], s[t]))) return !1;
            return !0;
        }
...
/** Creates a deep copy of `source`. */ function Wt(t) {
    ...
    if (t.mapValue) {
        ...
        return ft(t.mapValue.fields, ((t, n) => e.mapValue.fields[t] = Wt(n))), e;
    }
    if (t.arrayValue) {
        const e = {
            arrayValue: {
 ...
 */ class Ht {
     ...
     */    static newInvalidDocument(t) {
        return new Ht(t, 0 /* INVALID */ , ht.min(), Gt.empty(), 0 /* SYNCED */);
    }
    /**
     * Creates a new document that is known to exist with the given data at the
     * given version.
     */    static newFoundDocument(t, e, n) {
        return new Ht(t, 1 /* FOUND_DOCUMENT */ , e, n, 0 /* SYNCED */);
    }
    /** Creates a new document that is known to not exist at the given version. */    static newNoDocument(t, e) {
        return new Ht(t, 2 /* NO_DOCUMENT */ , e, Gt.empty(), 0 /* SYNCED */);
    }
    /**
     ...
     */    static newUnknownDocument(t, e) {
        return new Ht(t, 3 /* UNKNOWN_DOCUMENT */ , e, Gt.empty(), 2 /* HAS_COMMITTED_MUTATIONS */);
    }
    /**
    ...
    mutableCopy() {
        return new Ht(this.key, this.documentType, this.version, this.data.clone(), this.documentState);
    }
    toString() {
 ...
 * property.
 */ function Yt(t, e = null, n = [], s = [], i = null, r = null, o = null) {
...
function Xt(t) {
    ...
    if (null === e.R) {
        ...
        null !== e.collectionGroup && (t += "|cg:" + e.collectionGroup), t += "|f:", t += e.filters.map((t => se(t))).join(","), 
        t += "|ob:", t += e.orderBy.map((t => function(t) {
            // TODO(b/29183165): Make this collision robust.
            return t.field.canonicalString() + t.dir;
        }(t))).join(","), St(e.limit) || (t += "|l:", t += e.limit), e.startAt && (t += "|lb:", 
        t += de(e.startAt)), e.endAt && (t += "|ub:", t += de(e.endAt)), e.R = t;
    }
    return e.R;
}
...
function Zt(t) {
    ...
    St(t.limit) || (e += ", limit: " + t.limit), t.orderBy.length > 0 && (e += `, orderBy: [${t.orderBy.map((t => function(t) {
        return `${t.field.canonicalString()} (${t.dir})`;
    }(t))).join(", ")}]`), t.startAt && (e += ", startAt: " + de(t.startAt)), t.endAt && (e += ", endAt: " + de(t.endAt)), 
    `Target(${e})`;
}
...
function te(t, e) {
    ...
    for (let n = 0; n < t.orderBy.length; n++) if (!_e(t.orderBy[n], e.orderBy[n])) return !1;
    if (t.filters.length !== e.filters.length) return !1;
    for (let i = 0; i < t.filters.length; i++) if (n = t.filters[i], s = e.filters[i], 
    n.op !== s.op || !n.field.isEqual(s.field) || !xt(n.value, s.value)) return !1;
    var n, s;
...
class ne extends class {} {
    ...
    matches(t) {
        ...
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.v(Ot(e, this.value)) : null !== e && kt(this.value) === kt(e) && this.v(Ot(e, this.value));
...
/** A Filter that implements the array-contains operator. */ class ae extends ne {
    ...
    matches(t) {
        const e = t.data.field(this.field);
        return qt(e) && $t(e.arrayValue, this.value);
    }
}

/** A Filter that implements the IN operator. */ class ue extends ne {
    constructor(t, e) {
        super(t, "in" /* IN */ , e);
    }
    matches(t) {
...
/** A Filter that implements the not-in operator. */ class he extends ne {
    constructor(t, e) {
...
/** A Filter that implements the array-contains-any operator. */ class le extends ne {
    constructor(t, e) {
        super(t, "array-contains-any" /* ARRAY_CONTAINS_ANY */ , e);
    }
    matches(t) {
        const e = t.data.field(this.field);
        return !(!qt(e) || !e.arrayValue.values) && e.arrayValue.values.some((t => $t(this.value.arrayValue, t)));
    }
}
 ...
 */ function Pe(t) {
    ...
    if (null === e.S) {
        ...
        t.isKeyField() || e.S.push(new we(t)), e.S.push(new we(gt.keyField(), "asc" /* ASCENDING */)); else {
            let t = !1;
 ...
 */ function ve(t) {
    ...
    if (!e.D) if ("F" /* First */ === e.limitType) e.D = Yt(e.path, e.collectionGroup, Pe(e), e.filters, e.limit, e.startAt, e.endAt); else {
        ...
        // We need to swap the cursors to match the now-flipped query ordering.
                const n = e.endAt ? new fe(e.endAt.position, !e.endAt.before) : null, s = e.startAt ? new fe(e.startAt.position, !e.startAt.before) : null;
        // Now return as a LimitType.First query.
        e.D = Yt(e.path, e.collectionGroup, t, e.filters, e.limit, n, s);
    }
    return e.D;
}
...
function Se(t, e) {
    return te(ve(t), ve(e)) && t.limitType === e.limitType;
}
...
function De(t) {
    return `${Xt(ve(t))}|lt:${t.limitType}`;
}

function Ce(t) {
    return `Query(target=${Zt(ve(t))}; limitType=${t.limitType})`;
}
 ...
 */ function Le(t, e, n) {
    ...
    }(n, e) : t instanceof Ke ? je(t, e) : t instanceof Qe ? We(t, e) : function(t, e) {
        // PORTING NOTE: Since JavaScript's integer arithmetic is limited to 53 bit
        // precision and resolves overflows by reducing precision, we do not
        // manually cap overflows at 2^63.
        const n = Ue(t, e), s = ze(n) + ze(t.N);
        return Ut(n) && Ut(t.N) ? Oe(s) : $e(t.k, s);
    }(t, e);
}
 ...
 */ function Be(t, e, n) {
    ...
    // applications.
    return t instanceof Ke ? je(t, e) : t instanceof Qe ? We(t, e) : n;
}
 ...
 */ function Ue(t, e) {
    return t instanceof Ge ? Ut(n = e) || function(t) {
...
/** Transforms an array value via a union operation. */ class Ke extends Fe {
    constructor(t) {
...
function je(t, e) {
    const n = He(e);
    for (const e of t.elements) n.some((t => xt(t, e))) || n.push(e);
    return {
        arrayValue: {
            values: n
        }
...
function We(t, e) {
    let n = He(e);
    for (const e of t.elements) n = n.filter((t => !xt(t, e)));
    return {
        arrayValue: {
            values: n
        }
 ...
 */ function nn(t, e, n) {
    t instanceof an ? function(t, e, n) {
        ...
        // must have held.
        const s = t.value.clone(), i = ln(t.fieldTransforms, e, n.transformResults);
        ...
        const s = ln(t.fieldTransforms, e, n.transformResults), i = e.data;
        i.setAll(hn(t)), i.setAll(s), e.convertToFoundDocument(n.version, i).setHasCommittedMutations();
 ...
 */ function rn(t, e) {
    ...
    for (const s of t.fieldTransforms) {
        const t = e.data.field(s.field), i = Ue(s.transform, t || null);
...
function pn(t) {
    ...
    return F("GRPC error has no .code"), Q.UNKNOWN;
    switch (t) {
      case mn.OK:
        return Q.OK;
 ...
 *     Code.UNKNOWN.
 */ (gn = mn || (mn = {}))[gn.OK = 0] = "OK", gn[gn.CANCELLED = 1] = "CANCELLED", 
gn[gn.UNKNOWN = 2] = "UNKNOWN", gn[gn.INVALID_ARGUMENT = 3] = "INVALID_ARGUMENT", 
gn[gn.DEADLINE_EXCEEDED = 4] = "DEADLINE_EXCEEDED", gn[gn.NOT_FOUND = 5] = "NOT_FOUND", 
gn[gn.ALREADY_EXISTS = 6] = "ALREADY_EXISTS", gn[gn.PERMISSION_DENIED = 7] = "PERMISSION_DENIED", 
gn[gn.UNAUTHENTICATED = 16] = "UNAUTHENTICATED", gn[gn.RESOURCE_EXHAUSTED = 8] = "RESOURCE_EXHAUSTED", 
gn[gn.FAILED_PRECONDITION = 9] = "FAILED_PRECONDITION", gn[gn.ABORTED = 10] = "ABORTED", 
gn[gn.OUT_OF_RANGE = 11] = "OUT_OF_RANGE", gn[gn.UNIMPLEMENTED = 12] = "UNIMPLEMENTED", 
gn[gn.INTERNAL = 13] = "INTERNAL", gn[gn.UNAVAILABLE = 14] = "UNAVAILABLE", gn[gn.DATA_LOSS = 15] = "DATA_LOSS";
...
class Tn {
    ...
    insert(t, e) {
        return new Tn(this.comparator, this.root.insert(t, e, this.comparator).copy(null, null, In.BLACK, null, null));
    }
    // Returns a copy of the map, with the specified key removed.
    remove(t) {
        return new Tn(this.comparator, this.root.remove(t, this.comparator).copy(null, null, In.BLACK, null, null));
    }
...
class In {
    constructor(t, e, n, s, i) {
        this.key = t, this.value = e, this.color = null != n ? n : In.RED, this.left = null != s ? s : In.EMPTY, 
        this.right = null != i ? i : In.EMPTY, this.size = this.left.size + 1 + this.right.size;
    }
    // Returns a copy of the current node, optionally replacing pieces of it.
    copy(t, e, n, s, i) {
        return new In(null != t ? t : this.key, null != e ? e : this.value, null != n ? n : this.color, null != s ? s : this.left, null != i ? i : this.right);
    }
    isEmpty() {
        return !1;
    }
    ...
    removeMin() {
        if (this.left.isEmpty()) return In.EMPTY;
        let t = this;
    ...
    remove(t, e) {
        ...
        s = s.copy(null, null, null, s.left.remove(t, e), null); else {
            ...
            0 === e(t, s.key)) {
                if (s.right.isEmpty()) return In.EMPTY;
    ...
    rotateLeft() {
        const t = this.copy(null, null, In.RED, null, this.right.left);
        return this.right.copy(null, null, this.color, t, null);
    }
    rotateRight() {
        const t = this.copy(null, null, In.RED, this.left.right, null);
...
class An {
    ...
    copy(t) {
        const e = new An(this.comparator);
        return e.data = t, e;
    }
}
 ...
 */ class On {
     ...
     */    static createSynthesizedTargetChangeForCurrentChange(t, e) {
        return new On(Et.EMPTY_BYTE_STRING, e, Nn(), Nn(), Nn());
    }
}
...
class Un {
    ...
    ht(t) {
        let e = this.nt.get(t);
        return e || (e = new Bn, this.nt.set(t, e)), e;
    }
    Tt(t) {
        let e = this.it.get(t);
        return e || (e = new An(ot), this.it = this.it.insert(t, e)), e;
    }
    /**
...
function ts(t, e) {
    const n = Xn(e);
    if (n.get(1) !== t.databaseId.projectId) throw new W(Q.INVALID_ARGUMENT, "Tried to deserialize key from different project: " + n.get(1) + " vs " + t.databaseId.projectId);
    if (n.get(3) !== t.databaseId.database) throw new W(Q.INVALID_ARGUMENT, "Tried to deserialize key from different database: " + n.get(3) + " vs " + t.databaseId.database);
    return new Nt(is(n));
}
...
function os(t, e, n) {
    const s = ts(t, e.name), i = Jn(e.updateTime), r = new Gt({
        mapValue: {
            fields: e.fields
        }
    }), o = Ht.newFoundDocument(s, i, r);
...
function cs(t, e) {
    return "found" in e ? function(t, e) {
        ...
        return Ht.newFoundDocument(n, s, i);
    }(t, e) : "missing" in e ? function(t, e) {
        q(!!e.missing), q(!!e.readTime);
        const n = ts(t, e.missing), s = Jn(e.readTime);
        return Ht.newNoDocument(n, s);
    }(t, e) : U();
}
 ...
 */ (o);
        ...
        const i = ts(t, s.document.name), r = Jn(s.document.updateTime), o = new Gt({
            mapValue: {
...
function hs(t, e) {
    const n = e.currentDocument ? function(t) {
        return void 0 !== t.updateTime ? Ze.updateTime(Jn(t.updateTime)) : void 0 !== t.exists ? Ze.exists(t.exists) : Ze.none();
    }(e.currentDocument) : Ze.none(), s = e.updateTransforms ? e.updateTransforms.map((e => function(t, e) {
        let n = null;
        if ("setToServerValue" in e) q("REQUEST_TIME" === e.setToServerValue), n = new qe; else if ("appendMissingElements" in e) {
            const t = e.appendMissingElements.values || [];
            n = new Ke(t);
        } else if ("removeAllFromArray" in e) {
            const t = e.removeAllFromArray.values || [];
            n = new Qe(t);
        } else "increment" in e ? n = new Ge(t, e.increment) : U();
        const s = gt.fromServerFormat(e.fieldPath);
        return new Je(s, n);
    }(t, e))) : [];
    if (e.update) {
        e.update.name;
        const i = ts(t, e.update.name), r = new Gt({
            mapValue: {
...
function ls(t, e) {
    return t && t.length > 0 ? (q(void 0 !== e), t.map((t => function(t, e) {
        ...
        n = Jn(e)), new Xe(n, t.transformResults || []);
    }(t, e)))) : [];
}
 ...
 */ (t, e.limit);
    return null !== o && (n.structuredQuery.limit = o), e.startAt && (n.structuredQuery.startAt = gs(e.startAt)), 
    e.endAt && (n.structuredQuery.endAt = gs(e.endAt)), n;
}
...
function ms(t) {
    return t ? void 0 !== t.unaryFilter ? [ Rs(t) ] : void 0 !== t.fieldFilter ? [ As(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((t => ms(t))).reduce(((t, e) => t.concat(e))) : U() : [];
}
...
function As(t) {
    return ne.create(Is(t.fieldFilter.field), function(t) {
        switch (t) {
          case "EQUAL":
            return "==" /* EQUAL */;
...
function vs(t) {
    let e = "";
    for (let n = 0; n < t.length; n++) e.length > 0 && (e = Ss(e)), e = Vs(t.get(n), e);
    return Ss(e);
}
...
/** Name of the IndexedDb object store.  */ xs.store = "mutations", 
/** Keys are automatically assigned via the userId, batchId properties. */
xs.keyPath = "batchId", 
/** The index name for lookup of mutations by user. */
xs.userMutationsIndex = "userMutationsIndex", 
/** The user mutations index is keyed by [userId, batchId] pairs. */
xs.userMutationsKeyPath = [ "userId", "batchId" ];
...
Bs.queryTargetsIndexName = "queryTargetsIndex", 
/**
 * The index of all canonicalIds to the targets that they match. This is not
 * a unique mapping because canonicalId does not promise a unique name for all
 * possible queries, so we append the targetId to make the mapping unique.
 */
Bs.queryTargetsKeyPath = [ "canonicalId", "targetId" ];
...
/** Name of the IndexedDb object store.  */ Us.store = "targetDocuments", 
/** Keys are automatically assigned via the targetId, path properties. */
Us.keyPath = [ "targetId", "path" ], 
/** The index name for the reverse index. */
Us.documentTargetsIndex = "documentTargetsIndex", 
/** We also need to create the reverse index for these properties. */
Us.documentTargetsKeyPath = [ "path", "targetId" ];
 ...
 */ qs.key = "targetGlobalKey", qs.store = "targetGlobal";
...
/** Name of the IndexedDb object store. */ Ks.store = "collectionParents", 
/** Keys are automatically assigned via the collectionId, parent properties. */
Ks.keyPath = [ "collectionId", "parent" ];
...
// Visible for testing
const Gs = [ ...[ ...[ ...[ ...[ ks.store, xs.store, $s.store, Fs.store, Bs.store, Ns.store, qs.store, Us.store ], js.store ], Ls.store ], Ks.store ], Qs.store, Ws.store ], zs = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.";
 ...
 */ class Js {
    ...
    next(t, e) {
        return this.callbackAttached && U(), this.callbackAttached = !0, this.isDone ? this.error ? this.wrapFailure(e, this.error) : this.wrapSuccess(t, this.result) : new Js(((n, s) => {
            this.nextCallback = e => {
...
class Ys {
    constructor(t, e) {
         ...
         */
        this.It = new G, this.transaction.oncomplete = () => {
            this.It.resolve();
        }, this.transaction.onabort = () => {
            e.error ? this.It.reject(new ti(t, e.error)) : this.It.resolve();
        }, this.transaction.onerror = e => {
            const n = ri(e.target.error);
            this.It.reject(new ti(t, n));
        };
    }
    static open(t, e, n, s) {
        try {
            return new Ys(e, t.transaction(s, n));
        } catch (t) {
            throw new ti(e, t);
        }
    }
    ...
    abort(t) {
        t && this.It.reject(t), this.aborted || (M("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"), 
 ...
 */ class Xs {
    ...
    constructor(t, e, n) {
        ...
        // log on 12.2.
        12.2 === Xs.bt(h()) && F("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    /** Deletes the specified database. */    static delete(t) {
        return M("SimpleDb", "Removing database:", t), si(window.indexedDB.deleteDatabase(t)).toPromise();
    }
     ...
     */    async Ct(t) {
        return this.db || (M("SimpleDb", "Opening database:", this.name), this.db = await new Promise(((e, n) => {
            ...
            s.onsuccess = t => {
                ...
                n(new ti(t, "Cannot upgrade IndexedDB schema while another tab is open. Close all tabs that access Firestore and reload this page to proceed."));
            }, s.onerror = e => {
                const s = e.target.error;
                "VersionError" === s.name ? n(new W(Q.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : "InvalidStateError" === s.name ? n(new W(Q.FAILED_PRECONDITION, "Unable to open an IndexedDB connection. This could be due to running in a private browsing session on a browser whose private browsing sessions do not support IndexedDB: " + s)) : n(new ti(t, s));
            }, s.onupgradeneeded = t => {
    ...
    async runTransaction(t, e, n, s) {
        ...
        for (;;) {
            ...
            try {
                ...
                const e = Ys.open(this.db, t, i ? "readonly" : "readwrite", n), r = s(e).catch((t => (
 ...
 */ class Zs {
     ...
     */    delete() {
        return si(this.$t.delete());
    }
}

/** An error that wraps exceptions that thrown during IndexedDB execution. */ class ti extends W {
    constructor(t, e) {
    ...
    Ut(t, e) {
        ...
        return new Js(((s, i) => {
            t.onerror = t => {
                ...
                if (!i) return void s();
                const r = new Zs(i), o = e(i.primaryKey, i.value, r);
                if (o instanceof Js) {
...
function ri(t) {
    ...
    if (e >= 12.2 && e < 13) {
        ...
        if (t.message.indexOf(e) >= 0) {
            ...
            const t = new W("internal", `IOS_INDEXEDDB_BUG1: IndexedDb has thrown '${e}'. This is likely due to an unavoidable bug in iOS. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.`);
            return ii || (ii = !0, 
 ...
 */ class ai {
     ...
     */    applyToLocalView(t) {
        ...
        for (const e of this.baseMutations) e.key.isEqual(t.key) && sn(e, t, this.localWriteTime);
        // Second, apply all user-provided mutations.
                for (const e of this.mutations) e.key.isEqual(t.key) && sn(e, t, this.localWriteTime);
    }
    /**
...
/** The result of applying a mutation batch to the backend. */ class ui {
    constructor(t, e, n, 
    /**
 ...
 */ class hi {
    ...
    /** Creates a new target data instance with an updated sequence number. */    withSequenceNumber(t) {
        return new hi(this.target, this.targetId, this.purpose, t, this.snapshotVersion, this.lastLimboFreeSnapshotVersion, this.resumeToken);
    }
    /**
     * Creates a new target data instance with an updated resume token and
     * snapshot version.
     */    withResumeToken(t, e) {
        return new hi(this.target, this.targetId, this.purpose, this.sequenceNumber, e, this.lastLimboFreeSnapshotVersion, t);
    }
    /**
     * Creates a new target data instance with an updated last limbo free
     * snapshot version number.
     */    withLastLimboFreeSnapshotVersion(t) {
        return new hi(this.target, this.targetId, this.purpose, this.sequenceNumber, this.snapshotVersion, t, this.resumeToken);
    }
}
...
/** Decodes a remote document from storage locally to a Document. */ function fi(t, e) {
    if (e.document) return os(t.Gt, e.document, !!e.hasCommittedMutations);
    if (e.noDocument) {
        const t = Nt.fromSegments(e.noDocument.path), n = gi(e.noDocument.readTime), s = Ht.newNoDocument(t, n);
        return e.hasCommittedMutations ? s.setHasCommittedMutations() : s;
    }
    if (e.unknownDocument) {
        const t = Nt.fromSegments(e.unknownDocument.path), n = gi(e.unknownDocument.version);
        return Ht.newUnknownDocument(t, n);
    }
    return U();
}

/** Encodes a document for storage locally. */ function di(t, e, n) {
    const s = wi(n), i = e.key.path.popLast().toArray();
    ...
    if (e.isNoDocument()) {
        const t = e.key.path.toArray(), n = mi(e.version), r = e.hasCommittedMutations;
        return new Fs(
        /* unknownDocument= */ null, new Os(t, n), 
        /* document= */ null, r, s, i);
    }
    if (e.isUnknownDocument()) {
        const t = e.key.path.toArray(), n = mi(e.version);
        return new Fs(new Ms(t, n), 
        /* noDocument= */ null, 
        /* document= */ null, 
...
function yi(t, e) {
    const n = (e.baseMutations || []).map((e => hs(t.Gt, e)));
...
/** Decodes a DbTarget into TargetData */ function pi(t) {
    const e = gi(t.readTime), n = void 0 !== t.lastLimboFreeSnapshotVersion ? gi(t.lastLimboFreeSnapshotVersion) : ht.min();
    let s;
    var i;
    return void 0 !== t.query.documents ? (q(1 === (i = t.query).documents.length), 
    s = ve(Te(ns(i.documents[0])))) : s = function(t) {
        return ve(ws(t));
    }(t.query), new hi(s, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, e, n, Et.fromBase64String(t.resumeToken));
}
...
/** Encodes TargetData into a DbTarget for storage locally. */ function Ti(t, e) {
    ...
    let i;
    i = ee(e.target) ? fs(t.Gt, e.target) : ds(t.Gt, e.target);
    // We can't store the resumeToken as a ByteString in IndexedDb, so we
    // convert it to a base64 string for storage.
        const r = e.resumeToken.toBase64();
    // lastListenSequenceNumber is always 0 until we do real GC.
        return new Bs(e.targetId, Xt(e.target), n, r, e.sequenceNumber, s, i);
}
 ...
 */ class bi {
    ...
    getCollectionParents(t, e) {
        return Js.resolve(this.zt.getEntries(e));
    }
}
 ...
 */ class Pi {
    ...
    add(t) {
        const e = t.lastSegment(), n = t.popLast(), s = this.index[e] || new An(_t.comparator), i = !s.has(n);
    ...
    getEntries(t) {
        return (this.index[t] || new An(_t.comparator)).toArray();
    }
}
...
function Ci(t, e, n) {
    ...
    for (const t of n.mutations) {
        const s = $s.key(e, t.key.path, n.batchId);
...
class ki {
    ...
    lookupMutationBatch(t, e) {
        return $i(t).get(e).next((t => t ? (q(t.userId === this.userId), yi(this.k, t)) : null));
    }
    /**
    ...
    // PORTING NOTE: Multi-tab only.
    Zt(t, e) {
        return this.Yt[e] ? Js.resolve(this.Yt[e]) : this.lookupMutationBatch(t, e).next((t => {
            if (t) {
                const n = t.keys();
    ...
    getNextMutationBatchAfterBatchId(t, e) {
        ...
        return $i(t).jt({
            ...
            e.userId === this.userId && (q(e.batchId >= n), i = yi(this.k, e)), s.done();
        })).next((() => i));
    }
    ...
    getAllMutationBatches(t) {
        ...
        return $i(t).Bt(xs.userMutationsIndex, e).next((t => t.map((t => yi(this.k, t)))));
    }
    getAllMutationBatchesAffectingDocumentKey(t, e) {
        // Scan the document-mutation index starting with a prefix starting with
        // the given documentKey.
        const n = $s.prefixForPath(this.userId, e.path), s = IDBKeyRange.lowerBound(n), i = [];
        return Oi(t).jt({
            range: s
        }, ((n, s, r) => {
    ...
    getAllMutationBatchesAffectingQuery(t, e) {
        const n = e.path, s = n.length + 1, i = $s.prefixForPath(this.userId, n), r = IDBKeyRange.lowerBound(i);
    ...
    te(t, e) {
        ...
        return e.forEach((e => {
            s.push($i(t).get(e).next((t => {
                if (null === t) throw U();
                q(t.userId === this.userId), n.push(yi(this.k, t));
            })));
        })), Js.waitFor(s).next((() => n));
    }
    removeMutationBatch(t, e) {
        return Ci(t.Wt, this.userId, e).next((n => (t.addOnCommittedListener((() => {
            this.ee(e.batchId);
    ...
    performConsistencyCheck(t) {
        return this.checkEmpty(t).next((e => {
            ...
            // the queue is empty.
                        const n = IDBKeyRange.lowerBound($s.prefixForUser(this.userId)), s = [];
            return Oi(t).jt({
                range: n
            }, ((t, e, n) => {
                if (t[0] === this.userId) {
    ...
    ne(t) {
        return Mi(t).get(this.userId).next((t => t || new ks(this.userId, -1, 
        /*lastStreamToken=*/ "")));
    }
}
 ...
 */ function xi(t, e, n) {
    const s = $s.prefixForPath(e, n.path), i = s[1], r = IDBKeyRange.lowerBound(s);
    let o = !1;
    return Oi(t).jt({
        range: r,
        Kt: !0
 ...
 */ class Li {
    ...
    getLastRemoteSnapshotVersion(t) {
        return this.oe(t).next((t => ht.fromTimestamp(new ut(t.lastRemoteSnapshotVersion.seconds, t.lastRemoteSnapshotVersion.nanoseconds))));
    }
    ...
    getTargetData(t, e) {
        ...
        return Bi(t).jt({
            range: s,
            index: Bs.queryTargetsIndexName
        }, ((t, n, s) => {
            const r = pi(n);
            // After finding a potential match, check that the target is
            // actually equal to the requested target.
                        te(e, r.target) && (i = r, s.done());
        })).next((() => i));
    }
    addMatchingKeys(t, e, n) {
        ...
        return e.forEach((e => {
            const r = vs(e.path);
            s.push(i.put(new Us(n, r))), s.push(this.referenceDelegate.addReference(t, n, e));
        })), Js.waitFor(s);
    }
    ...
    // PORTING NOTE: Multi-tab only.
    Et(t, e) {
        return Bi(t).get(e).next((t => t ? pi(t) : null));
    }
}
 ...
 */ async function Ki(t) {
    if (t.code !== Q.FAILED_PRECONDITION || t.message !== zs) throw t;
 ...
 */ class Qi {
    constructor(t) {
        this.he = t, this.buffer = new An(ji), this.le = 0;
    }
    fe() {
        return ++this.le;
    }
    de(t) {
        ...
        if (this.buffer.size < this.he) this.buffer = this.buffer.add(e); else {
            ...
            ji(e, t) < 0 && (this.buffer = this.buffer.delete(t).add(e));
        }
    }
    get maxValue() {
 ...
 */ class Wi {
    ...
    me(t) {
        ...
        M("LruGarbageCollector", `Garbage collection scheduled in ${e}ms`), this._e = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection" /* LruGarbageCollection */ , e, (async () => {
            this._e = null, this.we = !0;
            try {
                await t.collectGarbage(this.garbageCollector);
            } catch (t) {
                ei(t) ? M("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", t) : await Ki(t);
            }
            await this.me(t);
        }));
    }
...
/** Implements the steps for LRU garbage collection. */ class Gi {
    ...
    collect(t, e) {
        ...
        Js.resolve(Si)) : this.getCacheSize(t).next((n => n < this.params.cacheSizeCollectionThreshold ? (M("LruGarbageCollector", `Garbage collection skipped; Cache size ${n} is lower than threshold ${this.params.cacheSizeCollectionThreshold}`), 
        Si) : this.Te(t, e)));
    }
    getCacheSize(t) {
...
class zi {
     ...
     */    Ae(t, e) {
        return function(t, e) {
            let n = !1;
            return Mi(t).Qt((s => xi(t, s, e).next((t => (t && (n = !0), Js.resolve(!t)))))).next((() => n));
        }(t, e);
    }
    removeOrphanedDocuments(t, e) {
        ...
        return this.Ie(t, ((r, o) => {
            if (o <= e) {
                const e = this.Ae(t, r).next((e => {
                    ...
                    // removing them.
                    return i++, n.getEntry(t, r).next((() => (n.removeEntry(r), qi(t).delete([ 0, vs(r.path) ]))));
                }));
                s.push(e);
            }
 ...
 */ class Xi {
    ...
    getMetadata(t) {
        return tr(t).get(Ls.key).next((t => (q(!!t), t)));
    }
    Re(t, e) {
...
class Zi extends Yi {
    ...
    constructor(t, e) {
        ...
        this.Ce = new Ji((t => t.toString()), ((t, e) => t.isEqual(e)));
    }
    applyChanges(t) {
        const e = [];
        let n = 0, s = new An(((t, e) => ot(t.canonicalString(), e.canonicalString())));
 ...
 * limitations under the License.
 */
/** Performs database creation and schema upgrades. */ class sr {
    constructor(t) {
        this.k = t;
    }
    /**
     ...
     */    Nt(t, e, n, s) {
        q(n < s && n >= 0 && s <= 11);
        const i = new Ys("createOrUpgrade", e);
        n < 1 && s >= 1 && (function(t) {
 ...
 */ (t), ir(t), function(t) {
        ...
        0 !== n && (!function(t) {
            t.deleteObjectStore(Us.store), t.deleteObjectStore(Bs.store), t.deleteObjectStore(qs.store);
        }(t), ir(t)), r = r.next((() => 
        /**
 ...
 */
        function(t) {
            const e = t.store(qs.store), n = new qs(
            /*highestTargetId=*/ 0, 
            /*lastListenSequenceNumber=*/ 0, ht.min().toTimestamp(), 
            /*targetCount=*/ 0);
 ...
 */ (i)))), n < 4 && s >= 4 && (0 !== n && (
        ...
        r = r.next((() => function(t, e) {
            return e.store(xs.store).Bt().next((n => {
                ...
                const s = e.store(xs.store), i = n.map((t => s.put(t)));
                return Js.waitFor(i);
            }));
        }(t, i)))), r = r.next((() => {
            !function(t) {
 ...
 */ (t);
    ...
    ke(t) {
        let e = 0;
        return t.store(Fs.store).jt(((t, n) => {
            e += Ni(n);
        })).next((() => {
            const n = new Ls(e);
    ...
    Ne(t) {
        const e = t.store(ks.store), n = t.store(xs.store);
        return e.Bt().next((e => Js.forEach(e, (e => {
            const s = IDBKeyRange.bound([ e.userId, -1 ], [ e.userId, e.lastAcknowledgedBatchId ]);
            return n.Bt(xs.userMutationsIndex, s).next((n => Js.forEach(n, (n => {
                q(n.userId === e.userId);
                const s = yi(this.k, n);
     ...
     */    xe(t) {
        const e = t.store(Us.store), n = t.store(Fs.store);
        return t.store(qs.store).get(qs.key).next((t => {
            const s = [];
            return n.jt(((n, i) => {
                const r = new _t(n), o = function(t) {
                    return [ 0, vs(t) ];
                }(r);
                s.push(e.get(o).next((n => n ? Js.resolve() : (n => e.put(new Us(0, vs(n), t.highestListenSequenceNumber)))(r))));
            })).next((() => Js.waitFor(s)));
        }));
    }
    $e(t, e) {
        ...
        return e.store(Fs.store).jt({
            Kt: !0
        }, ((t, e) => {
            const n = new _t(t);
            return i(n.popLast());
        })).next((() => e.store($s.store).jt({
            Kt: !0
        }, (([t, e, n], s) => {
            const r = Ds(e);
            return i(r.popLast());
    ...
    Oe(t) {
        const e = t.store(Bs.store);
        return e.jt(((t, n) => {
            const s = pi(n), i = Ti(this.k, s);
            return e.put(i);
        }));
    }
}
...
function ir(t) {
    t.createObjectStore(Us.store, {
        keyPath: Us.keyPath
    }).createIndex(Us.documentTargetsIndex, Us.documentTargetsKeyPath, {
        unique: !0
    });
    // NOTE: This is unique only because the TargetId is the suffix.
    t.createObjectStore(Bs.store, {
        keyPath: Bs.keyPath
    }).createIndex(Bs.queryTargetsIndexName, Bs.queryTargetsKeyPath, {
        unique: !0
    }), t.createObjectStore(qs.store);
}

const rr = "Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.";
 ...
 */
        ...
        (this.k, this.Jt), this.Ye = new Ii, this.window && this.window.localStorage ? this.Xe = this.window.localStorage : (this.Xe = null, 
     ...
     */    start() {
        ...
        return this.Ze().then((() => {
            ...
            throw new W(Q.FAILED_PRECONDITION, rr);
    ...
    getMutationQueue(t) {
        return ki.Xt(t, this.k, this.Jt, this.referenceDelegate);
    }
    getTargetCache() {
        return this.He;
    }
    ...
    runTransaction(t, e, n) {
        ...
        // are the only reader/writer.
                return this.ze.runTransaction(t, s, Gs, (s => (i = new oi(s, this.Be ? this.Be.next() : st.I), 
        "readwrite-primary" === e ? this.rn(i).next((t => !!t || this.on(i))).next((e => {
            ...
            this.Me.enqueueRetryable((() => this.We(!1))), new W(Q.FAILED_PRECONDITION, zs);
            return n(i);
    ...
    /** Checks the primary lease and removes it if we are the current primary. */    cn(t) {
        const e = cr(t);
        return e.get(Ns.key).next((t => this.un(t) ? (M("IndexedDbPersistence", "Releasing primary lease."), 
     ...
     */    en() {
        ...
        "function" == typeof (null === (t = this.window) || void 0 === t ? void 0 : t.addEventListener) && (this.qe = () => {
            ...
            this.mn(), f() && navigator.appVersion.match(/Version\/1[45]/) && 
 ...
 */
    ...
    Sn(t, e) {
        ...
        return this.Rn(t, new Nt(e)).next((t => {
            let e = Vn();
    ...
    Dn(t, e, n) {
        ...
        let i = Vn();
        return this.Jt.getCollectionParents(t, s).next((r => Js.forEach(r, (r => {
            const o = function(t, e) {
                return new ye(e, 
 ...
 */ (e, r.child(s));
    ...
    Cn(t, e, n) {
        ...
        this.Nn(t, i, s).next((t => {
            ...
            for (const t of i) for (const e of t.mutations) {
                ...
                i = Ht.newInvalidDocument(n), s = s.insert(n, i)), sn(e, i, t.localWriteTime), i.isFoundDocument() || (s = s.remove(n));
            }
        }))))).next((() => (
    ...
    Nn(t, e, n) {
        let s = Nn();
        for (const t of e) for (const e of t.mutations) e instanceof un && null === n.get(e.key) && (s = s.add(e.key));
        let i = n;
 ...
 */ class fr {
 ...
 // do nothing
        ...
        return new fr(t, e.fromCache, n, s);
    }
}
 ...
 */ class dr {
    ...
    /** Returns all local documents matching the specified query. */    getDocumentsMatchingQuery(t, e, n, s) {
        ...
        }(e) || n.isEqual(ht.min()) ? this.Fn(t, e) : this.Mn.vn(t, s).next((i => {
            const r = this.Ln(e, i);
            return (Ee(e) || Ie(e)) && this.Bn(e.limitType, r, s, n) ? this.Fn(t, e) : ($() <= c.DEBUG && M("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), Ce(e)), 
    ...
    Fn(t, e) {
        return $() <= c.DEBUG && M("QueryEngine", "Using full collection scan to execute query:", Ce(e)), 
        this.Mn.getDocumentsMatchingQuery(t, e, ht.min());
    }
}
...
class wr {
    ...
    t, e, n, s) {
        ...
        this.Kn = new Ji((t => Xt(t)), te), 
        /**
         * The read time of the last entry processed by `getNewDocumentChanges()`.
         *
         * PORTING NOTE: This is only used for multi-tab synchronization.
         */
        this.jn = ht.min(), this.An = t.getMutationQueue(n), this.Qn = t.getRemoteDocumentCache(), 
        this.He = t.getTargetCache(), this.Wn = new lr(this.Qn, this.An, this.persistence.getIndexManager()), 
...
async function mr(t, e) {
    ...
    const r = await n.persistence.runTransaction("Handle user change", "readonly", (t => {
        ...
        // MutationQueue.
        i = new lr(n.Qn, s, n.persistence.getIndexManager()), s.getAllMutationBatches(t)))).next((e => {
            const n = [], s = [];
 ...
 * queue.
 */ function pr(t, e) {
    const n = j(t), s = e.snapshotVersion;
    let i = n.qn;
    return n.persistence.runTransaction("Apply remote event", "readwrite-primary", (t => {
        ...
        e.targetChanges.forEach(((r, c) => {
            ...
            e.targetMismatches.has(c) ? u = u.withResumeToken(Et.EMPTY_BYTE_STRING, ht.min()).withLastLimboFreeSnapshotVersion(ht.min()) : r.resumeToken.approximateByteSize() > 0 && (u = u.withResumeToken(r.resumeToken, s)), 
            i = i.insert(c, u), 
...
i) {
    ...
    return n.forEach((t => r = r.add(t))), e.getEntries(t, r).next((t => {
        ...
        return n.forEach(((n, o) => {
            ...
            // cache.
            o.isNoDocument() && o.version.isEqual(ht.min()) ? (
            ...
            r = r.insert(n, o)) : M("LocalStore", "Ignoring outdated watch update for ", n, ". Current version:", c.version, " Watch version:", o.version);
        })), r;
    }));
}
...
function Ir(t, e) {
    ...
    return n.persistence.runTransaction("Allocate target", "readwrite", (t => {
        ...
        s = i, Js.resolve(s)) : n.He.allocateTargetId(t).next((i => (s = new hi(e, i, 0 /* Listen */ , t.currentSequenceNumber), 
...
async function Ar(t, e, n) {
    const s = j(t), i = s.qn.get(e), r = n ? "readwrite" : "readwrite-primary";
    try {
 ...
 */ function Rr(t, e, n) {
    ...
    return s.persistence.runTransaction("Execute query", "readonly", (t => function(t, e, n) {
        const s = j(t), i = s.Kn.get(n);
        return void 0 !== i ? Js.resolve(s.qn.get(i)) : s.He.getTargetData(e, n);
    }(s, t, ve(e)).next((e => {
        if (e) return i = e.lastLimboFreeSnapshotVersion, s.He.getMatchingKeysForTargetId(t, e.targetId).next((t => {
            r = t;
        }));
    })).next((() => s.Un.getDocumentsMatchingQuery(t, e, n ? i : ht.min(), n ? r : Nn()))).next((t => ({
        documents: t,
        zn: r
    })))));
}
...
async function vr(t) {
    ...
    return e.persistence.runTransaction("Synchronize last document change read time", "readonly", (t => function(t) {
        ...
        return e.jt({
            ...
            e.readTime && (n = _i(e.readTime)), s.done();
        })).next((() => n));
    }(t))).then((t => {
        e.jn = t;
    }));
...
async function Vr(t, e, n, s) {
    ...
    const a = i.Qn.newChangeBuffer({
        ...
        return ve(Te(_t.fromString(`__bundle__/docs/${t}`)));
    }(s));
 ...
 */
async function Sr(t, e, n = Nn()) {
    // Allocate a target for the named query such that it can be resumed
    // from associated read time if users use it to listen.
    // NOTE: this also means if no corresponding target exists, the new target
    // will remain active and will not get collected, unless users happen to
    // unlisten the query somehow.
    const s = await Ir(t, ve(Ei(e.bundledQuery))), i = j(t);
 ...
 */ class Dr {
    ...
    getNamedQuery(t, e) {
        return Js.resolve(this.Zn.get(e));
    }
    saveNamedQuery(t, e) {
 ...
 */ class Cr {
    constructor() {
        ...
        this.ts = new An(Nr.es), 
        // A set of outstanding references to a document sorted by target id.
        this.ns = new An(Nr.ss);
    }
     ...
     * removed.
     */    us(t) {
        const e = new Nt(new _t([])), n = new Nr(e, t), s = new Nr(e, t + 1), i = [];
    ...
    ls(t) {
        const e = new Nt(new _t([])), n = new Nr(e, t), s = new Nr(e, t + 1);
        let i = Nn();
        return this.ns.forEachInRange([ n, s ], (t => {
            i = i.add(t.key);
        })), i;
    ...
    containsKey(t) {
        const e = new Nr(t, 0), n = this.ts.firstAfterOrEqual(e);
...
class Nr {
    ...
    /** Compare by key then by ID */    static es(t, e) {
        return Nt.comparator(t.key, e.key) || ot(t.fs, e.fs);
    }
    /** Compare by ID then by key */    static ss(t, e) {
        return ot(t.fs, e.fs) || Nt.comparator(t.key, e.key);
    }
}
 ...
 */ class kr {
    constructor(t, e) {
        ...
        this.ws = new An(Nr.es);
    }
    checkEmpty(t) {
        return Js.resolve(0 === this.An.length);
    }
    addMutationBatch(t, e, n, s) {
        const i = this.ds;
    ...
    lookupMutationBatch(t, e) {
        return Js.resolve(this._s(e));
    }
    getNextMutationBatchAfterBatchId(t, e) {
        const n = e + 1, s = this.gs(n), i = s < 0 ? 0 : s;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return Js.resolve(this.An.length > i ? this.An[i] : null);
    }
    getHighestUnacknowledgedBatchId() {
        return Js.resolve(0 === this.An.length ? -1 : this.ds - 1);
    }
    getAllMutationBatches(t) {
        return Js.resolve(this.An.slice());
    }
    getAllMutationBatchesAffectingDocumentKey(t, e) {
    ...
    removeMutationBatch(t, e) {
        q(0 === this.ps(e.batchId, "removed")), this.An.shift();
        let n = this.ws;
    ...
    containsKey(t, e) {
        const n = new Nr(e, 0), s = this.ws.firstAfterOrEqual(n);
        return Js.resolve(e.isEqual(s && s.key));
    }
    performConsistencyCheck(t) {
        return this.An.length, Js.resolve();
    }
    /**
...
class xr {
    ...
    constructor(t, e) {
        ...
        this.docs = new Tn(Nt.comparator), 
    ...
    getDocumentsMatchingQuery(t, e, n) {
        ...
        for (;r.hasNext(); ) {
            ...
            o.compareTo(n) <= 0 || Ne(e, i) && (s = s.insert(i.key, i.mutableCopy()));
        }
        return Js.resolve(s);
    }
    Es(t, e) {
 ...
 */ class Or {
    constructor(t) {
         ...
         * IDs.
         */
        this.Rs = new Cr, this.targetCount = 0, this.bs = Fi.ie();
    }
    forEachTarget(t, e) {
    ...
    ae(t) {
        ...
        const e = t.targetId;
        e > this.highestTargetId && (this.bs = new Fi(e), this.highestTargetId = e), t.sequenceNumber > this.As && (this.As = t.sequenceNumber);
    }
    addTargetData(t, e) {
    ...
    addMatchingKeys(t, e, n) {
        return this.Rs.rs(e, n), Js.resolve();
    }
    removeMatchingKeys(t, e, n) {
        this.Rs.cs(e, n);
    ...
    removeMatchingKeysForTargetId(t, e) {
        return this.Rs.us(e), Js.resolve();
    }
    getMatchingKeysForTargetId(t, e) {
    ...
    containsKey(t, e) {
        return Js.resolve(this.Rs.containsKey(e));
    }
}
...
class Lr {
    ...
    addReference(t, e, n) {
        return this.Cs.addReference(n, e), this.xs.delete(n.toString()), Js.resolve();
    }
    removeReference(t, e, n) {
        return this.Cs.removeReference(n, e), this.xs.add(n.toString()), Js.resolve();
    }
    markPotentiallyOrphaned(t, e) {
    ...
    $s(t, e) {
        return Js.or([ () => Js.resolve(this.Cs.containsKey(e)), () => this.persistence.getTargetCache().containsKey(t, e), () => this.persistence.Ds(t, e) ]);
    }
}
...
class Kr {
     ...
     */    static Os(t, e, n) {
        ...
        r && (i = new W(s.error.code, s.error.message))), r ? new Kr(t, e, s.state, i) : (F("SharedClientState", `Failed to parse mutation state for ID '${e}': ${n}`), 
        null);
    }
    Ms() {
        const t = {
...
class jr {
     ...
     */    static Os(t, e) {
        ...
        i && (s = new W(n.error.code, n.error.message))), i ? new jr(t, n.state, s) : (F("SharedClientState", `Failed to parse target state for ID '${t}': ${e}`), 
        null);
    }
    Ms() {
        const t = {
 ...
 */ class Qr {
     ...
     */    static Os(t, e) {
        const n = JSON.parse(e);
        let s = "object" == typeof n && n.activeTargetIds instanceof Array, i = xn();
 ...
 */ class Wr {
     ...
     */    static Os(t) {
        ...
        return "object" == typeof e && -1 !== [ "Unknown", "Online", "Offline" ].indexOf(e.onlineState) && "string" == typeof e.clientId ? new Wr(e.clientId, e.onlineState) : (F("SharedClientState", `Failed to parse online state: ${t}`), 
        null);
    }
}
 ...
 */ class zr {
    constructor(t, e, n, s, i) {
        ...
        this.Ks = new Tn(ot), this.started = !1, 
        /**
        ...
        const r = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.window.localStorage, this.currentUser = i, this.Qs = Br(this.persistenceKey, this.Bs), 
        this.Ws = 
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ (this.persistenceKey), this.Ks = this.Ks.insert(this.Bs, new Gr), this.Gs = new RegExp(`^firestore_clients_${r}_([^_]*)$`), 
    ...
    addLocalQueryTarget(t) {
        ...
        // by another tab
            ...
            const n = this.storage.getItem(qr(this.persistenceKey, t));
            if (n) {
                const s = jr.Os(t, n);
                s && (e = s.state);
            }
    ...
    qs(t) {
        ...
        if (e.storageArea === this.storage) {
            if (M("SharedClientState", "EVENT", e.key, e.newValue), e.key === this.Qs) return void F("Received WebStorage notification for local change. Another client might have garbage-collected our state");
 ...
 */ (e.newValue);
                        t !== st.I && this.sequenceNumberHandler(t);
    ...
    ni(t, e, n) {
        const s = new Kr(this.currentUser, t, e, n), i = Ur(this.persistenceKey, this.currentUser, t);
        this.setItem(i, s.Ms());
    }
    si(t) {
        const e = Ur(this.persistenceKey, this.currentUser, t);
        this.removeItem(e);
    }
    oi(t) {
        const e = {
...
class Hr {
    constructor() {
        this.pi = new Gr, this.Ti = {}, this.onlineStateHandler = null, this.sequenceNumberHandler = null;
    }
    addPendingMutation(t) {
        // No op.
    }
    ...
    start() {
        return this.pi = new Gr, Promise.resolve();
    }
    handleUserChange(t, e, n) {
        // No op.
    }
...
class {
    ...
    Bi(t, e, n, s, i) {
        ...
        const o = {};
        return this.qi(o, s, i), this.Ki(t, r, o, n).then((t => (M("RestConnection", "Received: ", t), 
        t)), (e => {
            throw L("RestConnection", `${t} failed with error: `, e, "url: ", r, "request:", n), 
            e;
        }));
    }
    ji(t, e, n, s, i) {
            ...
            o.listenOnce(A.COMPLETE, (() => {
                try {
                    switch (o.getLastErrorCode()) {
                      ...
                      case R.TIMEOUT:
                        M("Connection", 'RPC "' + t + '" timed out'), r(new W(Q.DEADLINE_EXCEEDED, "Request time out"));
                        break;
                      ...
                      case R.HTTP_ERROR:
                        ...
                        n > 0) {
                            ...
                            if (t && t.status && t.message) {
                                ...
                                r(new W(e, t.message));
                            } else r(new W(Q.UNKNOWN, "Server responded with status " + o.getStatus()));
                        } else 
                        // If we received an HTTP_ERROR but there's no status code,
                        // it's most probably a connection issue
                        r(new W(Q.UNAVAILABLE, "Connection failed."));
                        break;
    ...
    Qi(t, e, n) {
        const s = [ this.Fi, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], i = b(), r = P(), o = {
        ...
        this.useFetchStreams && (o.xmlHttpFactory = new v({})), this.qi(o.initMessageHeaders, e, n), 
        ...
        // on a closed stream
                const l = new Zr({
            Vi: t => {
                h ? M("Connection", "Not sending because WebChannel is closed:", t) : (u || (M("Connection", "Opening WebChannel transport."), 
        ...
        // enough the code is exception free.
            ...
            h || (h = !0, M("Connection", "WebChannel transport closed"), l.Oi());
 ...
 */
                ...
                } else M("Connection", "WebChannel received:", n), l.Mi(n);
            }
        })), f(r, S.STAT_EVENT, (t => {
            t.stat === D.PROXY ? M("Connection", "Detected buffering proxy") : t.stat === D.NOPROXY && M("Connection", "Detected no buffering proxy");
        })), setTimeout((() => {
...
class io {
     ...
     */    Zi(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                s > 0 && M("ExponentialBackoff", `Backing off for ${s} ms (base delay: ${this.Hi} ms, delay with jitter: ${e} ms, last attempt: ${n} ms ago)`), 
...
class ro {
     ...
     */    async close(t, e) {
        ...
        this.ur.reset() : e && e.code === Q.RESOURCE_EXHAUSTED ? (
        // Log the error. (Probably either 'quota exceeded' or 'max queue length reached'.)
        F(e.toString()), F("Using maximum backoff delay to prevent overloading the backend."), 
        this.ur.Xi()) : e && e.code === Q.UNAUTHENTICATED && 3 /* Healthy */ !== this.state && (
    ...
    auth() {
        ...
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
            ...
            t((() => {
                const t = new W(Q.UNKNOWN, "Fetching auth token failed: " + e.message);
                return this.Ar(t);
            }));
        }));
    }
     ...
     */    Er(t) {
        return e => {
            this.Me.enqueueAndForget((() => this.rr === t ? e() : (M("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
            Promise.resolve())));
        };
    }
}
 ...
 */ class oo extends ro {
     ...
     */    Pr(t) {
        ...
        e.database = ss(this.k), e.addTarget = function(t, e) {
            ...
            return n = ee(s) ? {
                ...
                query: ds(t, s)
            }, n.targetId = e.targetId, e.resumeToken.approximateByteSize() > 0 ? n.resumeToken = zn(t, e.resumeToken) : e.snapshotVersion.compareTo(ht.min()) > 0 && (
     ...
     */    vr(t) {
        const e = {};
        e.database = ss(this.k), e.removeTarget = t, this.gr(e);
    }
}
 ...
 */ class co extends ro {
    ...
    onMessage(t) {
        ...
        q(!!t.streamToken), this.lastStreamToken = t.streamToken, this.Vr) {
            // A successful first write response means the stream is healthy,
            // Note, that we could consider a successful handshake healthy, however,
            // the write itself might be causing an error we want to back off from.
            this.ur.reset();
            const e = ls(t.writeResults, t.commitTime), n = Jn(t.commitTime);
            return this.listener.Cr(n, e);
        }
        // The first response is always the handshake response
        return q(!t.writeResults || 0 === t.writeResults.length), this.Vr = !0, this.listener.Nr();
    }
    /**
...
class ao extends class {} {
    ...
    Or() {
        if (this.$r) throw new W(Q.FAILED_PRECONDITION, "The client has already been terminated.");
    }
    /** Invokes the provided RPC with auth and AppCheck tokens. */    Bi(t, e, n) {
        return this.Or(), Promise.all([ this.authCredentials.getToken(), this.appCheckCredentials.getToken() ]).then((([s, i]) => this.ir.Bi(t, e, n, s, i))).catch((t => {
            ...
            this.appCheckCredentials.invalidateToken()), t) : new W(Q.UNKNOWN, t.toString());
        }));
    }
...
class uo {
    ...
    qr(t) {
        ...
        this.Lr ? (F(e), this.Lr = !1) : M("OnlineStateTracker", e);
    }
    jr() {
    ...
    e, n, s, i) {
        ...
        this.zr = [], this.Hr = i, this.Hr.Ei((t => {
            n.enqueueAndForget((async () => {
                ...
                // down our streams.
                To(this) && (M("RemoteStore", "Restarting streams for network reachability change."), 
                await async function(t) {
                    const e = j(t);
                    e.Gr.add(4 /* ConnectivityChange */), await fo(e), e.Jr.set("Unknown" /* Unknown */), 
                    e.Gr.delete(4 /* ConnectivityChange */), await lo(e);
                }(this));
            }));
        })), this.Jr = new uo(n, s);
    }
...
async function lo(t) {
    if (To(t)) for (const e of t.zr) await e(/* enabled= */ !0);
}
...
async function Ro(t, e, n) {
    ...
    t.Jr.set("Online" /* Online */), e instanceof Ln && 2 /* Removed */ === e.state && e.cause) 
 ...
 */ (t, e);
        ...
        await bo(t, n);
    } else if (e instanceof Mn ? t.Yr.ot(e) : e instanceof Fn ? t.Yr.dt(e) : t.Yr.ut(e), 
 ...
 */
        function(t, e) {
            ...
            n.targetMismatches.forEach((e => {
                ...
                const s = new hi(n.target, e, 1 /* ExistenceFilterMismatch */ , n.sequenceNumber);
                mo(t, s);
            })), t.remoteSyncer.applyRemoteEvent(n);
        }(t, n);
    } catch (e) {
        M("RemoteStore", "Failed to raise snapshot:", e), await bo(t, e);
    }
}
 ...
 */ async function bo(t, e, n) {
    ...
    await fo(t), t.Jr.set("Offline" /* Offline */), n || (
    ...
    t.asyncQueue.enqueueRetryable((async () => {
        M("RemoteStore", "Retrying IndexedDB access"), await n(), t.Gr.delete(1 /* IndexedDbFailed */), 
        await lo(t);
    }));
}
 ...
 */ function Fo(t) {
    ...
    t.Xr = function(t, e, n) {
        const s = j(t);
        return s.Or(), new oo(e, s.ir, s.authCredentials, s.appCheckCredentials, s.k, n);
    }
    /**
 * @license
 * Copyright 2018 Google LLC
 ...
 */ function Lo(t) {
    ...
    t.Zr = function(t, e, n) {
        ...
        await vo(t)) : (await t.Zr.stop(), t.Qr.length > 0 && (M("RemoteStore", `Stopping write stream with ${t.Qr.length} pending writes`), 
        t.Qr = []));
    }))), t.Zr;
}
...
class Bo {
     ...
     */    cancel(t) {
        null !== this.timerHandle && (this.clearTimeout(), this.deferred.reject(new W(Q.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    }
    handleDelayElapsed() {
 ...
 */ class qo {
    ...
    constructor(t) {
        ...
        this.keyedMap = Vn(), this.sortedSet = new Tn(this.comparator);
    }
    /**
 ...
 */ class tc {
     ...
     */    Jn(t) {
        return t.metadata.exists ? os(this.k, t.document, !1) : Ht.newNoDocument(this.Hn(t.metadata.name), this.Yn(t.metadata.readTime));
    }
    Yn(t) {
        return Jn(t);
    }
 ...
 */ class rc {
     ...
     */    Po(t, e) {
        ...
        })), Ee(this.query) || Ie(this.query)) for (;r.size > this.query.limit; ) {
 ...
 */ class ac {
    ...
    s, i, r) {
        ...
        this.currentUser = i, this.maxConcurrentLimboResolutions = r, this.Oo = {}, this.Mo = new Ji((t => De(t)), Se), 
        this.Fo = new Map, 
        /**
         ...
         * active target.
         */
        this.Bo = new Tn(Nt.comparator), 
        /**
         * Keeps track of the information about an active limbo resolution for each
         * active target ID that was started for the purpose of limbo resolution.
         */
        this.Uo = new Map, this.qo = new Cr, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.Ko = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.jo = new Map, this.Qo = Fi.re(), this.onlineState = "Unknown" /* Unknown */ , 
    ...
    try {
        const t = await function(t, e) {
            ...
            return n.persistence.runTransaction("Locally write mutations", "readwrite", (t => n.Wn.vn(t, i).next((i => {
                ...
                const o = [];
                for (const t of e) {
                    const e = rn(t, r.get(t.key));
                    null != e && 
                    // NOTE: The base state should only be applied if there's some
                    // existing document to override, so use a Precondition of
                    // exists=true
                    o.push(new un(t.key, e, zt(e.value.mapValue), Ze.exists(!0)));
                }
 ...
 */ async function _c(t, e, n) {
    ...
    if (r) {
        ...
        let t = new Tn(Nt.comparator);
        t = t.insert(r, Ht.newNoDocument(r, ht.min()));
    ...
    try {
        const t = await function(t, e) {
            ...
            return n.persistence.runTransaction("Reject batch", "readwrite-primary", (t => {
                let s;
                return n.An.lookupMutationBatch(t, e).next((e => (q(null !== e), s = e.keys(), n.An.removeMutationBatch(t, e)))).next((() => n.An.performConsistencyCheck(t))).next((() => n.Wn.vn(t, s)));
            }));
        }
        /**
...
async function Nc(t, e) {
    ...
    if (Fc(n), Lc(n), !0 === e && !0 !== n.Wo) {
        ...
        function(t) {
            ...
            e.Uo.forEach(((t, n) => {
                _o(e.remoteStore, n);
            })), e.qo.hs(), e.Uo = new Map, e.Bo = new Tn(Nt.comparator);
        }
        /**
...
async function Oc(t, e, n, s) {
    ...
    M("SyncEngine", "Ignoring unexpected query state notification."); else if (i.Fo.has(e)) switch (n) {
      case "current":
      case "not-current":
        {
 ...
 */ (t.localStore, s), n._completeWith(o.progress);
            ...
            L("SyncEngine", `Loading bundle failed with ${t}`), n._failWith(t);
        }
    }
    /**
 * @license
...
class Uc {
    ...
    async initialize(t) {
        this.k = so(t.databaseInfo.databaseId), this.sharedClientState = this.Jo(t), this.persistence = this.Yo(t), 
    ...
    Zo(t) {
        return _r(this.persistence, new dr, t.initialUser, this.k);
    }
    Yo(t) {
        return new Mr(Lr.ks, this.k);
    }
    Jo(t) {
        return new Hr;
    }
 ...
 */ class qc extends Uc {
    ...
    Xo(t) {
        ...
        return new Wi(e, t.asyncQueue);
    }
    Yo(t) {
        const e = ur(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey), n = void 0 !== this.cacheSizeBytes ? Di.withCacheSize(this.cacheSizeBytes) : Di.DEFAULT;
        return new or(this.synchronizeTabs, e, t.clientId, n, t.asyncQueue, eo(), no(), this.k, this.sharedClientState, !!this.forceOwnership);
    }
    Jo(t) {
        return new Hr;
    }
 ...
 */ class jc {
    ...
    terminate() {
        return async function(t) {
            const e = j(t);
            M("RemoteStore", "RemoteStore shutting down."), e.Gr.add(5 /* Shutdown */), await fo(e), 
            e.Hr.shutdown(), 
...
class zc {
    ...
    async lookup(t) {
        if (this.ensureCommitNotCalled(), this.mutations.length > 0) throw new W(Q.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
        const e = await async function(t, e) {
            const n = j(t), s = ss(n.k) + "/documents", i = {
    ...
    async commit() {
        ...
        t.forEach(((t, e) => {
            ...
            this.mutations.push(new wn(n, this.precondition(n)));
        })), await async function(t, e) {
            const n = j(t), s = ss(n.k) + "/documents", i = {
                writes: e.map((t => us(n.k, t)))
            };
    ...
    recordVersion(t) {
        ...
        if (n) {
            ...
            throw new W(Q.ABORTED, "Document version changed between two reads.");
     ...
     */    precondition(t) {
        ...
        return !this.writtenDocs.has(t.toString()) && e ? Ze.updateTime(e) : Ze.none();
    }
    /**
     ...
     */    preconditionForUpdate(t) {
        ...
        // read time and existence
            ...
            // transaction.
            throw new W(Q.INVALID_ARGUMENT, "Can't update a document that doesn't exist.");
...
class Hc {
    ...
    _c(t) {
        if ("FirebaseError" === t.name) {
            ...
            const e = t.code;
            return "aborted" === e || "failed-precondition" === e || !yn(e);
        }
        return !1;
    }
}
...
class Jc {
     ...
     */    verifyNotTerminated() {
        if (this.asyncQueue.isShuttingDown) throw new W(Q.FAILED_PRECONDITION, "The client has already been terminated.");
    }
    terminate() {
...
async function Yc(t, e) {
    ...
    t.setCredentialChangeListener((async t => {
        s.isEqual(t) || (await mr(e.localStore, t), s = t);
    })), 
...
class Pa {
    constructor(t) {
        var e;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new W(Q.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
            this.host = "firestore.googleapis.com", this.ssl = true;
        } else this.host = t.host, this.ssl = null === (e = t.ssl) || void 0 === e || e;
        if (this.credentials = t.credentials, this.ignoreUndefinedProperties = !!t.ignoreUndefinedProperties, 
        void 0 === t.cacheSizeBytes) this.cacheSizeBytes = 41943040; else {
            if (-1 !== t.cacheSizeBytes && t.cacheSizeBytes < 1048576) throw new W(Q.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
 ...
 */ (t));
     ...
     * instance.
     */    get app() {
        if (!this._app) throw new W(Q.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
        return this._app;
    }
    get _initialized() {
    ...
    _setSettings(t) {
        ...
        this._settings = new Pa(t), void 0 !== t.credentials && (this._authCredentials = function(t) {
            ...
            switch (t.type) {
              ...
              default:
                throw new W(Q.INVALID_ARGUMENT, "makeAuthCredentialsProvider failed due to invalid credential type");
            }
        }(t.credentials));
    }
    _getSettings() {
...
function Va(t, e, n, s = {}) {
    ...
    t._setSettings(Object.assign(Object.assign({}, r), {
        ...
        let e, n;
        if ("string" == typeof s.mockUserToken) e = s.mockUserToken, n = N.MOCK_USER; else {
            // Let createMockUserToken validate first (catches common mistakes like
            // invalid field "uid" and missing field "sub" / "user_id".)
            e = p(s.mockUserToken, null === (i = t._app) || void 0 === i ? void 0 : i.options.projectId);
            const r = s.mockUserToken.sub || s.mockUserToken.user_id;
            if (!r) throw new W(Q.INVALID_ARGUMENT, "mockUserToken must contain 'sub' or 'user_id' field!");
            n = new N(r);
        }
 ...
 */ class Ma {
    constructor() {
        ...
        this.bc = () => {
            const t = no();
            t && M("AsyncQueue", "Visibility state changed to " + t.visibilityState), this.ur.er();
        };
        const t = no();
 ...
 */ function qa(t, e) {
    ...
    if (n.isInitialized()) {
        ...
        if (E(s, e)) return t;
        throw new W(Q.FAILED_PRECONDITION, "initializeFirestore() has already been called with different options. To avoid this error, call initializeFirestore() with the same options as when it was originally called, or call getFirestore() to return the already initialized instance.");
    }
    if (void 0 !== e.cacheSizeBytes && -1 !== e.cacheSizeBytes && e.cacheSizeBytes < 1048576) throw new W(Q.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
    return n.initialize({
        options: e
    });
}
...
class su {
     ...
     */
    constructor(...t) {
        for (let e = 0; e < t.length; ++e) if (0 === t[e].length) throw new W(Q.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
 ...
 */ class cu {
     ...
     */
    constructor(t, e) {
        if (!isFinite(t) || t < -90 || t > 90) throw new W(Q.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t);
        if (!isFinite(e) || e < -180 || e > 180) throw new W(Q.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + e);
...
/** The result of parsing "update" data (i.e. for an updateData call). */ class hu {
    ...
    toMutation(t, e) {
        return new un(t, this.data, this.fieldMask, e, this.fieldTransforms);
    }
}
...
class Eu extends ou {
    ...
    _toFieldTransform(t) {
        const e = new Ge(t.k, Me(t.k, this.Gc));
 ...
 */ (t, e), null;
    ...
    return function(t, e) {
        if (null === (t = T(t))) return {
            nullValue: "NULL_VALUE"
        };
        if ("number" == typeof t) return Me(e.k, t);
 ...
 */ class Bu {
     ...
     */    docChanges(t = {}) {
        ...
        if (e && this._snapshot.excludesMetadataChanges) throw new W(Q.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
...
class zu extends ju {
    ...
    _apply(t) {
        const e = function(t, e, n) {
            if (null !== t.startAt) throw new W(Q.INVALID_ARGUMENT, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
            if (null !== t.endAt) throw new W(Q.INVALID_ARGUMENT, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
            const s = new we(e, n);
            return function(t, e) {
                if (null === Ae(t)) {
        ...
        return function(t, e, n, s, i, r) {
            ...
            for (let r = 0; r < i.length; r++) {
                ...
                if (o[r].field.isKeyField()) {
                    ...
                    if (!be(t) && -1 !== a.indexOf("/")) throw new W(Q.INVALID_ARGUMENT, `Invalid query. When querying a collection and ordering by documentId(), the value passed to ${s}() must be a plain document ID, but '${a}' contains a slash.`);
                    const n = t.path.child(_t.fromString(a));
                    if (!Nt.isDocumentKey(n)) throw new W(Q.INVALID_ARGUMENT, `Invalid query. When querying a collection group and ordering by documentId(), the value passed to ${s}() must result in a valid document path, but '${n}' is not because it contains an odd number of segments.`);
                    const i = new Nt(n);
                    c.push(Bt(e, i));
                } else {
                    const t = Ru(n, s, a);
 ...
 */ class fh {
    ...
    _verifyNotCommitted() {
        if (this._committed) throw new W(Q.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }
}
