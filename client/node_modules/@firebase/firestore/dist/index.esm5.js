...
import { FirebaseError as l, getUA as d, isSafari as p, isMobileCordova as y, isReactNative as v, isElectron as m, isIE as g, isUWP as w, isBrowserExtension as b, getModularInstance as I, createMockUserToken as T, deepEqual as E, isIndexedDBAvailable as S } from "@firebase/util";

import { XhrIo as _, EventType as A, ErrorCode as k, createWebChannelTransport as D, getStatEventTarget as N, FetchXmlHttpFactory as C, WebChannel as x, Event as R, Stat as L } from "@firebase/webchannel-wrapper";

var P = "@firebase/firestore", O = /** @class */ function() {
    function t(t) {
        this.uid = t;
    }
 ...
 */ var H = {
    ...
    return t.prototype.start = function(t, e) {
        ...
        this.o = function() {
            i.i++, i.currentUser = i.u(), u.resolve(), u = new J, t.enqueueRetryable((function() {
        ...
        setTimeout((function() {
            if (!i.auth) {
                ...
                U("FirebaseAuthCredentialsProvider", "Auth not yet detected"), u.resolve(), u = new J);
            }
        }), 0), a();
    ...
    return t.prototype.start = function(t, e) {
        ...
        this.o = function(n) {
            t.enqueueRetryable((function() {
                return function(t) {
                    return null != t.error && U("FirebaseAppCheckTokenProvider", "Error getting App Check token; using placeholder token instead. Error: " + t.error.message), 
                    e(t.token);
                }(n);
            }));
        };
        ...
        return this.forceRefresh = !1, this.appCheck ? this.appCheck.getToken(t).then((function(t) {
            return t ? (z("string" == typeof t.token), new rt(t.token)) : null;
        })) : Promise.resolve(null);
    }, t.prototype.invalidateToken = function() {
        this.forceRefresh = !0;
    }, t.prototype.shutdown = function() {
...
/** Helper to compare arrays using isEqual(). */ function ht(t, e, n) {
 ...
 */ var mt = /** @class */ function() {
    ...
    n.fromString = function() {
        ...
        // for legacy reasons and should not be used frequently).
            ...
            var s = o[i];
            if (s.indexOf("//") >= 0) throw new Y(H.INVALID_ARGUMENT, "Invalid segment (" + s + "). Paths must not contain // in them.");
    ...
    n.fromServerFormat = function(t) {
        ...
        if (o(), s) throw new Y(H.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
        return new n(e);
    }, n.emptyPath = function() {
        return new n([]);
    }, n;
    ...
    return t.prototype.covers = function(t) {
        ...
        return ht(this.fields, t.fields, (function(t, e) {
            return t.isEqual(e);
        }));
    }, t;
}();
...
function Vt(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = ct(At(t.latitude), At(e.latitude));
            return 0 !== n ? n : ct(At(t.longitude), At(e.longitude));
...
/** Creates a deep copy of `source`. */ function Ht(t) {
    ...
    if (t.mapValue) {
        ...
        return yt(t.mapValue.fields, (function(t, n) {
 ...
 */ function Jt(t) {
    var e = [];
    return yt(t.fields, (function(t, n) {
        var r = new bt([ t ]);
        if (Wt(n)) {
            var i = Jt(n.mapValue).fields;
            if (0 === i.length) 
...
var Xt = /** @class */ function() {
    ...
    return t.newInvalidDocument = function(e) {
        return new t(e, 0 /* INVALID */ , dt.min(), Yt.empty(), 0 /* SYNCED */);
    }, 
    /**
    ...
    /** Creates a new document that is known to not exist at the given version. */ t.newNoDocument = function(e, n) {
        return new t(e, 2 /* NO_DOCUMENT */ , n, Yt.empty(), 0 /* SYNCED */);
    }, 
    /**
    ...
    t.newUnknownDocument = function(e, n) {
        return new t(e, 3 /* UNKNOWN_DOCUMENT */ , n, Yt.empty(), 2 /* HAS_COMMITTED_MUTATIONS */);
    }, 
    /**
...
function te(t) {
    ...
    if (null === e.R) {
        ...
        })).join(","), xt(e.limit) || (n += "|l:", n += e.limit), e.startAt && (n += "|lb:", 
        n += de(e.startAt)), e.endAt && (n += "|ub:", n += de(e.endAt)), e.R = n;
    }
    return e.R;
}
...
var re = /** @class */ function(e) {
     ...
     */    return t(n, e), n.create = function(t, e, r) {
        return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.P(t, e, r) : new ie(t, e, r) : "array-contains" /* ARRAY_CONTAINS */ === e ? new ae(t, r) : "in" /* IN */ === e ? new ce(t, r) : "not-in" /* NOT_IN */ === e ? new he(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new fe(t, r) : new n(t, e, r);
    }, n.P = function(t, e, n) {
        return "in" /* IN */ === e ? new oe(t, n) : new se(t, n);
    }, n.prototype.matches = function(t) {
        var e = t.data.field(this.field);
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.v(Vt(e, this.value)) : null !== e && Ot(this.value) === Ot(e) && this.v(Vt(e, this.value));
...
}(re), oe = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t, "in" /* IN */ , n) || this).keys = ue("in" /* IN */ , n), 
        r;
    }
    return t(n, e), n.prototype.matches = function(t) {
...
}(re), se = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t, "not-in" /* NOT_IN */ , n) || this).keys = ue("not-in" /* NOT_IN */ , n), 
        r;
    }
    return t(n, e), n.prototype.matches = function(t) {
        return !this.keys.some((function(e) {
...
/** Filter that matches on key fields within an array. */ function ue(t, e) {
    var n;
...
/** A Filter that implements the IN operator. */ function de(t) {
    // TODO(b/29183165): Make this collision robust.
 ...
 */ function ve(t, e, n) {
    for (var r = 0, i = 0; i < t.position.length; i++) {
        ...
        if (r = o.field.isKeyField() ? Pt.comparator(Pt.fromName(s.referenceValue), n.key) : Vt(s, n.data.field(o.field)), 
...
/** Creates a new Query instance with the options provided. */ function we(t, e, n, r, i, o, s, u) {
    return new ge(t, e, n, r, i, o, s, u);
}
 ...
 * paths.
 */ function Ie(t) {
    return !xt(t.limit) && "F" /* First */ === t.limitType;
}

function Te(t) {
    return !xt(t.limit) && "L" /* Last */ === t.limitType;
}
 ...
 */ function ke(t) {
    ...
    if (!e.D) if ("F" /* First */ === e.limitType) e.D = Zt(e.path, e.collectionGroup, Ae(e), e.filters, e.limit, e.startAt, e.endAt); else {
        ...
        var n = [], r = 0, i = Ae(e); r < i.length; r++) {
            ...
            n.push(new pe(o.field, s));
        }
        // We need to swap the cursors to match the now-flipped query ordering.
                var u = e.endAt ? new le(e.endAt.position, !e.endAt.before) : null, a = e.startAt ? new le(e.startAt.position, !e.startAt.before) : null;
        // Now return as a LimitType.First query.
                e.D = Zt(e.path, e.collectionGroup, n, e.filters, e.limit, u, a);
    }
    return e.D;
}
...
function Ne(t, e) {
    return ee(ke(t), ke(e)) && t.limitType === e.limitType;
}
...
function xe(t) {
    return "Query(target=" + function(t) {
        ...
        xt(t.limit) || (e += ", limit: " + t.limit), t.orderBy.length > 0 && (e += ", orderBy: [" + t.orderBy.map((function(t) {
            return function(t) {
                return t.field.canonicalString() + " (" + t.dir + ")";
            }(t);
        })).join(", ") + "]"), t.startAt && (e += ", startAt: " + de(t.startAt)), t.endAt && (e += ", endAt: " + de(t.endAt)), 
        "Target(" + e + ")";
...
/** Returns whether `doc` matches the constraints of `query`. */ function Re(t, e) {
    return e.isFoundDocument() && function(t, e) {
        ...
        return !(t.startAt && !ve(t.startAt, Ae(t), e)) && (!t.endAt || !ve(t.endAt, Ae(t), e));
    }(t, e);
}

function Le(t) {
    return function(e, n) {
        for (var r = !1, i = 0, o = Ae(t); i < o.length; i++) {
            var s = o[i], u = Pe(s, e, n);
            if (0 !== u) return u;
 ...
 */ function qe(t, e, n) {
    ...
    }(n, e) : t instanceof Ke ? Ge(t, e) : t instanceof ze ? Qe(t, e) : function(t, e) {
 ...
 */ function Ue(t, e, n) {
    ...
    // applications.
    return t instanceof Ke ? Ge(t, e) : t instanceof ze ? Qe(t, e) : n;
}
 ...
 */ function Be(t, e) {
    return t instanceof We ? Kt(n = e) || function(t) {
...
/** Transforms a value into a server-generated timestamp. */ var je = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return t(n, e), n;
}(Ve), Ke = /** @class */ function(e) {
    function n(t) {
        var n = this;
 ...
 * limitations under the License.
 */
/** A field path and the TransformOperation to perform upon it. */ var Je = function(t, e) {
 ...
 */ function en(t, e, n) {
    t instanceof un ? function(t, e, n) {
        ...
        if (Ze(t.precondition, e)) {
            ...
            i.setAll(cn(t)), i.setAll(r), e.convertToFoundDocument(n.version, i).setHasCommittedMutations();
 ...
 */ function nn(t, e, n) {
    t instanceof un ? function(t, e, n) {
        if (Ze(t.precondition, e)) {
            var r = t.value.clone(), i = fn(t.fieldTransforms, n, e);
            r.setAll(i), e.convertToFoundDocument(sn(e), r).setHasLocalMutations();
        }
    }(t, e, n) : t instanceof an ? function(t, e, n) {
        if (Ze(t.precondition, e)) {
            var r = fn(t.fieldTransforms, n, e), i = e.data;
            i.setAll(cn(t)), i.setAll(r), e.convertToFoundDocument(sn(e), i).setHasLocalMutations();
        }
    }(t, e, n) : function(t, e) {
        Ze(t.precondition, e) && 
 ...
 */ function rn(t, e) {
    for (var n = null, r = 0, i = t.fieldTransforms; r < i.length; r++) {
        var o = i[r], s = e.data.field(o.field), u = Be(o.transform, s || null);
        null != u && (null == n && (n = Yt.empty()), n.set(o.field, u));
    }
    return n || null;
}
 ...
 */ function fn(t, e, n) {
    for (var r = new Map, i = 0, o = t; i < o.length; i++) {
        ...
        r.set(s.field, qe(u, a, e));
    }
    return r;
}

/** A mutation that deletes the document at the given key. */ var ln, dn, pn = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
 ...
 *     Code.UNKNOWN.
 */ (dn = ln || (ln = {}))[dn.OK = 0] = "OK", dn[dn.CANCELLED = 1] = "CANCELLED", 
...
var wn = /** @class */ function() {
    function t(t, e) {
        this.comparator = t, this.root = e || In.EMPTY;
    }
    // Returns a copy of the map, with the specified key/value added or replaced.
        return t.prototype.insert = function(e, n) {
        return new t(this.comparator, this.root.insert(e, n, this.comparator).copy(null, null, In.BLACK, null, null));
    }, 
    // Returns a copy of the map, with the specified key removed.
    t.prototype.remove = function(e) {
        return new t(this.comparator, this.root.remove(e, this.comparator).copy(null, null, In.BLACK, null, null));
    }, 
    ...
    t.prototype.getIterator = function() {
        return new bn(this.root, null, this.comparator, !1);
    }, t.prototype.getIteratorFrom = function(t) {
        return new bn(this.root, t, this.comparator, !1);
    }, t.prototype.getReverseIterator = function() {
        return new bn(this.root, null, this.comparator, !0);
    }, t.prototype.getReverseIteratorFrom = function(t) {
        return new bn(this.root, t, this.comparator, !0);
    }, t;
}(), bn = /** @class */ function() {
    function t(t, e, n, r) {
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
In.EMPTY = null, In.RED = !0, In.BLACK = !1, 
// end LLRBEmptyNode
In.EMPTY = new (/** @class */ function() {
    function t() {
        this.size = 0;
    }
...
var Dn = new wn(Pt.comparator);

function Nn() {
    return Dn;
}

var Cn = new Tn(Pt.comparator);

function xn() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    for (var n = Cn, r = 0, i = t; r < i.length; r++) {
        var o = i[r];
        n = n.add(o);
    }
    return n;
 ...
 */ var Pn = /** @class */ function() {
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, On.createSynthesizedTargetChangeForCurrentChange(e, n)), new t(dt.min(), r, Ln(), _n(), xn());
    }, t;
}(), On = /** @class */ function() {
    function t(
    /**
...
/** An RPC error indicating why the watch failed. */ , r) {
    void 0 === n && (n = Et.EMPTY_BYTE_STRING), void 0 === r && (r = null), this.state = t, 
    ...
    function t() {
        ...
        this.B = Et.EMPTY_BYTE_STRING, this.U = !1, 
        /**
    ...
    return t.prototype.ot = function(t) {
        for (var e = 0, n = t.$; e < n.length; e++) {
            var r = n[e];
            t.O && t.O.isFoundDocument() ? this.ct(r, t.O) : this.at(r, t.key, t.O);
        }
    ...
    t.prototype.dt = function(t) {
        ...
        if (r) {
            ...
            if (ne(i)) if (0 === n) {
                ...
                // queries.
                var o = new Pt(i.path);
                this.at(e, o, Xt.newNoDocument(o, dt.min()));
            } else z(1 === n); else this._t(e) !== n && (
    ...
    t.prototype.gt = function(t) {
        ...
        this.nt.forEach((function(r, i) {
            ...
            if (o) {
                if (r.current && ne(o.target)) {
                    ...
                    var s = new Pt(o.target.path);
                    null !== e.st.get(s) || e.yt(i, s) || e.at(i, s, Xt.newNoDocument(s, t));
                }
                r.j && (n.set(i, r.G()), r.H());
            }
        }));
        ...
        var i = new Pn(t, n, this.rt, this.st, r);
        return this.st = _n(), this.it = Bn(), this.rt = new Tn(ct), i;
    }, 
    /**
    ...
    t.prototype.X = function(t) {
        ...
        var e = this.nt.get(t);
        return e || (e = new qn, this.nt.set(t, e)), e;
    }, t.prototype.Tt = function(t) {
        var e = this.it.get(t);
        return e || (e = new Tn(ct), this.it = this.it.insert(t, e)), e;
    }, 
    /**
    ...
    t.prototype.ft = function(t) {
        var e = this;
        this.nt.set(t, new qn), this.et.getRemoteKeysForTarget(t).forEach((function(n) {
...
function er(t) {
    ...
    // in the local target cache.
        return 4 === e.length ? gt.emptyPath() : rr(e);
}
...
function or(t, e, n) {
    var r = Zn(t, e.name), i = Yn(e.updateTime), o = new Yt({
        mapValue: {
            fields: e.fields
        }
    }), s = Xt.newFoundDocument(r, i, o);
...
function sr(t, e) {
    ...
    if (e instanceof un) n = {
        update: ir(t, e.key, e.value)
    }; else if (e instanceof pn) n = {
        delete: $n(t, e.key)
    }; else if (e instanceof an) n = {
        update: ir(t, e.key, e.data),
        updateMask: br(e.fieldMask)
    }; else {
        if (!(e instanceof yn)) return G();
        n = {
            verify: $n(t, e.key)
        };
    }
...
function ur(t, e) {
    var n = e.currentDocument ? function(t) {
        return void 0 !== t.updateTime ? $e.updateTime(Yn(t.updateTime)) : void 0 !== t.exists ? $e.exists(t.exists) : $e.none();
    }(e.currentDocument) : $e.none(), r = e.updateTransforms ? e.updateTransforms.map((function(e) {
        return function(t, e) {
            var n = null;
            if ("setToServerValue" in e) z("REQUEST_TIME" === e.setToServerValue), n = new je; else if ("appendMissingElements" in e) {
                var r = e.appendMissingElements.values || [];
                n = new Ke(r);
            } else if ("removeAllFromArray" in e) {
                var i = e.removeAllFromArray.values || [];
                n = new ze(i);
            } else "increment" in e ? n = new We(t, e.increment) : G();
    ...
    if (e.update) {
        e.update.name;
        var i = Zn(t, e.update.name), o = new Yt({
            mapValue: {
...
function cr(t, e) {
    ...
    null !== e.collectionGroup ? (n.parent = tr(t, r), n.structuredQuery.from = [ {
        collectionId: e.collectionGroup,
        allDescendants: !0
    } ]) : (n.parent = tr(t, r.popLast()), n.structuredQuery.from = [ {
    ...
    return null !== s && (n.structuredQuery.limit = s), e.startAt && (n.structuredQuery.startAt = lr(e.startAt)), 
    e.endAt && (n.structuredQuery.endAt = lr(e.endAt)), n;
}
...
function hr(t) {
    ...
    var s = [];
    n.where && (s = fr(n.where));
    var u = [];
    n.orderBy && (u = n.orderBy.map((function(t) {
        return function(t) {
            return new pe(mr(t.field), 
            // visible for testing
            function(t) {
                switch (t) {
                  case "ASCENDING":
    ...
    n.limit && (a = function(t) {
        var e;
        return xt(e = "object" == typeof t ? t.value : t) ? null : e;
    }(n.limit));
    var c = null;
    n.startAt && (c = dr(n.startAt));
    var h = null;
    return n.endAt && (h = dr(n.endAt)), we(e, i, u, s, a, "F" /* First */ , c, h);
}

function fr(t) {
    return t ? void 0 !== t.unaryFilter ? [ wr(t) ] : void 0 !== t.fieldFilter ? [ gr(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((function(t) {
        return fr(t);
    })).reduce((function(t, e) {
        return t.concat(e);
    })) : G() : [];
...
function gr(t) {
    return re.create(mr(t.fieldFilter.field), function(t) {
        switch (t) {
          case "EQUAL":
            return "==" /* EQUAL */;
...
function wr(t) {
    switch (t.unaryFilter.op) {
      case "IS_NAN":
        var e = mr(t.unaryFilter.field);
        return re.create(e, "==" /* EQUAL */ , {
            doubleValue: NaN
        });

      case "IS_NULL":
        var n = mr(t.unaryFilter.field);
        return re.create(n, "==" /* EQUAL */ , {
            nullValue: "NULL_VALUE"
        });

      case "IS_NOT_NAN":
        var r = mr(t.unaryFilter.field);
        return re.create(r, "!=" /* NOT_EQUAL */ , {
            doubleValue: NaN
        });

      case "IS_NOT_NULL":
        var i = mr(t.unaryFilter.field);
        return re.create(i, "!=" /* NOT_EQUAL */ , {
            nullValue: "NULL_VALUE"
        });
 ...
 */ function Tr(t) {
    for (var e = "", n = 0; n < t.length; n++) e.length > 0 && (e = Sr(e)), e = Er(t.get(n), e);
    return Sr(e);
}

/** Encodes a single segment of a resource path into the given result */ function Er(t, e) {
...
/** Name of the IndexedDb object store.  */ Dr.store = "mutationQueues", 
...
/**
     ...
     */
Lr.readTimeIndex = "readTimeIndex", Lr.readTimeIndexPath = "readTime", 
/**
     ...
     */
Lr.collectionReadTimeIndex = "collectionReadTimeIndex", Lr.collectionReadTimeIndexPath = [ "parentPath", "readTime" ];
...
/** Name of the IndexedDb object store. */ Vr.store = "collectionParents", 
...
/** Name of the IndexedDb object store. */ qr.store = "clientMetadata", 
...
/** Name of the IndexedDb object store. */ Ur.store = "bundles", Ur.keyPath = "bundleId";
...
// Visible for testing
var jr = e(e([], e(e([], e(e([], e(e([], [ Dr.store, Nr.store, Cr.store, Lr.store, Or.store, kr.store, Fr.store, Mr.store ]), [ qr.store ])), [ Pr.store ])), [ Vr.store ])), [ Ur.store, Br.store ]), Kr = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.", Gr = /** @class */ function() {
    function t() {
    ...
    return t.prototype.catch = function(t) {
        ...
        var r = this;
        return this.callbackAttached && G(), this.callbackAttached = !0, this.isDone ? this.error ? this.wrapFailure(n, this.error) : this.wrapSuccess(e, this.result) : new t((function(t, i) {
    ...
    function t(t, e) {
        ...
        /**
             ...
             */
        this.It = new J, this.transaction.oncomplete = function() {
            n.It.resolve();
        }, this.transaction.onabort = function() {
            e.error ? n.It.reject(new Yr(t, e.error)) : n.It.resolve();
        }, this.transaction.onerror = function(e) {
            var r = ti(e.target.error);
            n.It.reject(new Yr(t, r));
        };
    }
    return t.open = function(e, n, r, i) {
        ...
        t && this.It.reject(t), this.aborted || (U("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"), 
    ...
    function t(e, n, r) {
        ...
        // log on 12.2.
        12.2 === t.bt(d()) && B("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    /** Deletes the specified database. */    return t.delete = function(t) {
        return U("SimpleDb", "Removing database:", t), $r(window.indexedDB.deleteDatabase(t)).toPromise();
    }, 
    /** Returns true if IndexedDB is available in the current environment. */ t.Pt = function() {
        ...
        // Check the UA string to find out the browser.
                var e = d(), n = t.bt(e), r = 0 < n && n < 10, i = t.Vt(e), o = 0 < i && i < 4.5;
        // IE 10
                    ...
                    n = "readonly" === e, s = 0, u = function() {
                        ...
                        return r(this, (function(r) {
                            switch (r.label) {
                              ...
                              case 1:
                                return r.trys.push([ 1, 4, , 5 ]), [ 4 /*yield*/ , a.Ct(t) ];

                              case 2:
                                // Wait for the transaction to complete (i.e. IndexedDb's onsuccess event to
                                // fire), but still return the original transactionFnResult back to the
                                // caller.
                                return a.db = r.sent(), e = Qr.open(a.db, t, n ? "readonly" : "readwrite", i), u = o(e).catch((function(t) {
                                    // Abort the transaction if there was an error.
                                    return e.abort(t), zr.reject(t);
                                })).toPromise(), c = {}, u.catch((function() {})), [ 4 /*yield*/ , e.At ];
                              ...
                              case 4:
                                return h = r.sent(), f = "FirebaseError" !== h.name && s < 3, U("SimpleDb", "Transaction failed with error:", h.message, "Retrying:", f), 
 ...
 * on persistence.
 */
/** Verifies whether `e` is an IndexedDbTransactionError. */ function Jr(t) {
 ...
 */ var Xr = /** @class */ function() {
    ...
    t.prototype.add = function(t) {
        return U("SimpleDb", "ADD", this.store.name, t, t), $r(this.store.add(t));
    }, 
    /**
    ...
    t.prototype.get = function(t) {
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
                return $r(this.store.get(t)).next((function(n) {
            // Normalize nonexistence to null.
            return void 0 === n && (n = null), U("SimpleDb", "GET", e.store.name, t, n), n;
        }));
    }, t.prototype.delete = function(t) {
        return U("SimpleDb", "DELETE", this.store.name, t), $r(this.store.delete(t));
    }, 
    /**
    ...
    t.prototype.count = function() {
        return U("SimpleDb", "COUNT", this.store.name), $r(this.store.count());
    ...
    t.prototype.Qt = function(t) {
        var e = this.cursor({});
        return new zr((function(n, r) {
            e.onerror = function(t) {
                var e = ti(t.target.error);
                r(e);
 ...
 */ var ri = /** @class */ function() {
    ...
    return t.prototype.applyToRemoteDocument = function(t, e) {
        for (var n = e.mutationResults, r = 0; r < this.mutations.length; r++) {
            ...
            i.key.isEqual(t.key) && en(i, t, n[r]);
        }
    }, 
    /**
    ...
    t.prototype.applyToLocalView = function(t) {
        ...
        for (var e = 0, n = this.baseMutations; e < n.length; e++) {
            var r = n[e];
            r.key.isEqual(t.key) && nn(r, t, this.localWriteTime);
        }
        // Second, apply all user-provided mutations.
                for (var i = 0, o = this.mutations; i < o.length; i++) {
            var s = o[i];
            s.key.isEqual(t.key) && nn(s, t, this.localWriteTime);
        }
    }, 
    /**
    ...
    t.prototype.applyToLocalDocumentSet = function(t) {
        ...
        return this.batchId === t.batchId && ht(this.mutations, t.mutations, (function(t, e) {
            return on(t, e);
        })) && ht(this.baseMutations, t.baseMutations, (function(t, e) {
            return on(t, e);
        }));
    }, t;
}(), ii = /** @class */ function() {
     ...
     * time from which the server should resume sending results.
     */ , s) {
        void 0 === i && (i = dt.min()), void 0 === o && (o = dt.min()), void 0 === s && (s = Et.EMPTY_BYTE_STRING), 
...
/** Decodes a remote document from storage locally to a Document. */ function ui(t, e) {
    if (e.document) return or(t.Gt, e.document, !!e.hasCommittedMutations);
    if (e.noDocument) {
        var n = Pt.fromSegments(e.noDocument.path), r = li(e.noDocument.readTime), i = Xt.newNoDocument(n, r);
        return e.hasCommittedMutations ? i.setHasCommittedMutations() : i;
    }
    if (e.unknownDocument) {
        var o = Pt.fromSegments(e.unknownDocument.path), s = li(e.unknownDocument.version);
        return Xt.newUnknownDocument(o, s);
    }
    return G();
}

/** Encodes a document for storage locally. */ function ai(t, e, n) {
    var r = ci(n), i = e.key.path.popLast().toArray();
    ...
    if (e.isNoDocument()) {
        var u = e.key.path.toArray(), a = fi(e.version), c = e.hasCommittedMutations;
        return new Lr(
        /* unknownDocument= */ null, new xr(u, a), 
        /* document= */ null, c, r, i);
    }
    if (e.isUnknownDocument()) {
        var h = e.key.path.toArray(), f = fi(e.version);
        return new Lr(new Rr(h, f), 
        /* noDocument= */ null, 
        /* document= */ null, 
...
function hi(t) {
    var e = new lt(t[0], t[1]);
    return dt.fromTimestamp(e);
}

function fi(t) {
    var e = t.toTimestamp();
    return new Ar(e.seconds, e.nanoseconds);
}

function li(t) {
    var e = new lt(t.seconds, t.nanoseconds);
    return dt.fromTimestamp(e);
}
...
/** Decodes a DbMutationBatch into a MutationBatch */ function di(t, e) {
    ...
    var s = e.mutations.map((function(e) {
        return ur(t.Gt, e);
    })), u = lt.fromMillis(e.localWriteTimeMs);
    return new ri(e.batchId, u, n, s);
}

/** Decodes a DbTarget into TargetData */ function pi(t) {
    var e, n, r = li(t.readTime), i = void 0 !== t.lastLimboFreeSnapshotVersion ? li(t.lastLimboFreeSnapshotVersion) : dt.min();
    return void 0 !== t.query.documents ? (z(1 === (n = t.query).documents.length), 
    e = ke(be(er(n.documents[0])))) : e = function(t) {
        return ke(hr(t));
    }(t.query), new oi(e, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, r, i, Et.fromBase64String(t.resumeToken))
    /** Encodes TargetData into a DbTarget for storage locally. */;
}

function yi(t, e) {
    var n, r = fi(e.snapshotVersion), i = fi(e.lastLimboFreeSnapshotVersion);
    n = ne(e.target) ? ar(t.Gt, e.target) : cr(t.Gt, e.target);
    // We can't store the resumeToken as a ByteString in IndexedDb, so we
    // convert it to a base64 string for storage.
    var o = e.resumeToken.toBase64();
    // lastListenSequenceNumber is always 0 until we do real GC.
        return new Or(e.targetId, te(e.target), r, o, e.sequenceNumber, i, n);
}
 ...
 */ function gi(t) {
    return ni(t, Ur.store);
}

/**
 * Helper to get a typed SimpleDbStore for the namedQueries object store.
 */ function wi(t) {
    return ni(t, Br.store);
}
 ...
 */ var bi = /** @class */ function() {
    ...
    return t.prototype.addToCollectionParentIndex = function(t, e) {
        return this.zt.add(e), zr.resolve();
    }, t.prototype.getCollectionParents = function(t, e) {
        return zr.resolve(this.zt.getEntries(e));
    }, t;
}(), Ii = /** @class */ function() {
    function t() {
        this.index = {};
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e] || new Tn(gt.comparator), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new Tn(gt.comparator)).toArray();
    }, t;
}(), Ti = /** @class */ function() {
    function t() {
        /**
     ...
     */    return t.prototype.addToCollectionParentIndex = function(t, e) {
        ...
        var n = [], r = IDBKeyRange.bound([ e, "" ], [ ft(e), "" ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return Ei(t).Bt(r).next((function(t) {
 ...
 */
function Ai(t, e, n) {
    var r = t.store(Nr.store), i = t.store(Cr.store), o = [], s = IDBKeyRange.only(n.batchId), u = 0, a = r.jt({
        range: s
    }, (function(t, e, n) {
        return u++, n.delete();
    }));
    ...
    for (var c = [], h = 0, f = n.mutations; h < f.length; h++) {
        var l = f[h], d = Cr.key(e, l.key.path, n.batchId);
        o.push(i.delete(d)), c.push(l.key);
    }
    return zr.waitFor(o).next((function() {
        return c;
    }));
}
...
var Di = /** @class */ function() {
    ...
    return t.Xt = function(e, n, r, i) {
        ...
        return s.add({}).next((function(u) {
            z("number" == typeof u);
            for (var a = new ri(u, e, n, r), c = function(t, e, n) {
            ...
            }(i.k, i.userId, a), h = [], f = new Tn((function(t, e) {
                return ct(t.canonicalString(), e.canonicalString());
            })), l = 0, d = r; l < d.length; l++) {
                var p = d[l], y = Cr.key(i.userId, p.key.path, u);
                f = f.add(p.key.path.popLast()), h.push(s.put(c)), h.push(o.put(y, Cr.PLACEHOLDER));
            }
            return f.forEach((function(e) {
                h.push(i.Jt.addToCollectionParentIndex(t, e));
            })), t.addOnCommittedListener((function() {
                i.Yt[u] = a.keys();
            })), zr.waitFor(h).next((function() {
                return a;
            }));
        }));
        ...
        return Ci(t).get(e).next((function(t) {
            return t ? (z(t.userId === n.userId), di(n.k, t)) : null;
        }));
    }, 
    /**
    ...
    t.prototype.Zt = function(t, e) {
        var n = this;
        return this.Yt[e] ? zr.resolve(this.Yt[e]) : this.lookupMutationBatch(t, e).next((function(t) {
            if (t) {
                var r = t.keys();
                return n.Yt[e] = r, r;
            }
        ...
        return Ci(t).jt({
            ...
            e.userId === n.userId && (z(e.batchId >= r), o = di(n.k, e)), i.done();
        })).next((function() {
            return o;
        }));
        ...
        return Ci(t).Bt(Nr.userMutationsIndex, n).next((function(t) {
        ...
        // the given documentKey.
            ...
            return Ci(t).get(c).next((function(t) {
                if (!t) throw G();
                z(t.userId === n.userId), o.push(di(n.k, t));
            }));
            s.done();
        })).next((function() {
            return o;
        ...
        var n = this, r = new Tn(ct), i = [];
        return e.forEach((function(e) {
            var o = Cr.prefixForPath(n.userId, e.path), s = IDBKeyRange.lowerBound(o), u = xi(t).jt({
                range: s
            }, (function(t, i, o) {
                var s = t[0], u = t[1], a = t[2], c = _r(u);
                // Only consider rows matching exactly the specific key of
                // interest. Note that because we order by path first, and we
                // order terminators before path separators, we'll encounter all
                // the index rows for documentKey contiguously. In particular, all
            ...
            i.push(u);
        })), zr.waitFor(i).next((function() {
            return n.te(t, r);
        }));
    }, t.prototype.getAllMutationBatchesAffectingQuery = function(t, e) {
        var n = this, r = e.path, i = r.length + 1, o = Cr.prefixForPath(this.userId, r), s = IDBKeyRange.lowerBound(o), u = new Tn(ct);
        return xi(t).jt({
            range: s
        }, (function(t, e, o) {
            var s = t[0], a = t[1], c = t[2], h = _r(a);
        ...
        return e.forEach((function(e) {
            i.push(Ci(t).get(e).next((function(t) {
                if (null === t) throw G();
                z(t.userId === n.userId), r.push(di(n.k, t));
            })));
        })), zr.waitFor(i).next((function() {
            return r;
        }));
        ...
        var n = this;
        return Ai(t.Wt, this.userId, e).next((function(r) {
            return t.addOnCommittedListener((function() {
                n.ee(e.batchId);
            })), zr.forEach(r, (function(e) {
    ...
    t.prototype.ne = function(t) {
        var e = this;
        return Ri(t).get(this.userId).next((function(t) {
            return t || new Dr(e.userId, -1, 
            /*lastStreamToken=*/ "");
        }));
    }, t;
}();
 ...
 */ function Ni(t, e, n) {
    var r = Cr.prefixForPath(e, n.path), i = r[1], o = IDBKeyRange.lowerBound(r), s = !1;
    return xi(t).jt({
        range: o,
        Kt: !0
    }, (function(t, n, r) {
 ...
 */ function Ci(t) {
    return ni(t, Nr.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function xi(t) {
    return ni(t, Cr.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function Ri(t) {
    return ni(t, Dr.store);
}
 ...
 */ var Li = /** @class */ function() {
    ...
    // out to have a meaningful performance impact.
        ...
        return this.oe(t).next((function(n) {
            var r = new Li(n.highestTargetId);
            return n.highestTargetId = r.next(), e.ce(t, n).next((function() {
                return n.highestTargetId;
            }));
        }));
    }, t.prototype.getLastRemoteSnapshotVersion = function(t) {
        return this.oe(t).next((function(t) {
            return dt.fromTimestamp(new lt(t.lastRemoteSnapshotVersion.seconds, t.lastRemoteSnapshotVersion.nanoseconds));
        }));
        ...
        return this.oe(t).next((function(i) {
            ...
            e > i.highestListenSequenceNumber && (i.highestListenSequenceNumber = e), r.ce(t, i);
        }));
    }, t.prototype.addTargetData = function(t, e) {
        var n = this;
        return this.ae(t, e).next((function() {
            return n.oe(t).next((function(r) {
                return r.targetCount += 1, n.ue(e, r), n.ce(t, r);
            }));
        }));
        ...
        return this.removeMatchingKeysForTargetId(t, e.targetId).next((function() {
            ...
            return z(e.targetCount > 0), e.targetCount -= 1, n.ce(t, e);
        }));
    }, 
    /**
    ...
    t.prototype.ue = function(t, e) {
        ...
        var n = te(e), r = IDBKeyRange.bound([ n, Number.NEGATIVE_INFINITY ], [ n, Number.POSITIVE_INFINITY ]), i = null;
        return Oi(t).jt({
            range: r,
 ...
 */ function Vi(t) {
    return n(this, void 0, void 0, (function() {
        return r(this, (function(e) {
            if (t.code !== H.FAILED_PRECONDITION || t.message !== Kr) throw t;
 ...
 * limitations under the License.
 */ function qi(t, e) {
    var n = t[0], r = t[1], i = e[0], o = e[1], s = ct(n, i);
    return 0 === s ? ct(r, o) : s;
}
 ...
 */ var Ui = /** @class */ function() {
    function t(t) {
        this.he = t, this.buffer = new Tn(qi), this.le = 0;
    }
    return t.prototype.fe = function() {
        ...
        if (this.buffer.size < this.he) this.buffer = this.buffer.add(e); else {
            ...
            qi(e, n) < 0 && (this.buffer = this.buffer.delete(n).add(e));
        }
    ...
    return t.prototype.start = function(t) {
        ...
        U("LruGarbageCollector", "Garbage collection scheduled in " + i + "ms"), this._e = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection" /* LruGarbageCollection */ , i, (function() {
            return n(e, void 0, void 0, (function() {
                ...
                return r(this, (function(n) {
                    switch (n.label) {
                      ...
                      case 3:
                        return Jr(e = n.sent()) ? (U("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", e), 
                        [ 3 /*break*/ , 6 ]) : [ 3 /*break*/ , 4 ];
    ...
    return t.prototype.calculateTargetCount = function(t, e) {
        ...
        zr.resolve(Si)) : this.getCacheSize(t).next((function(r) {
        ...
        return this.calculateTargetCount(t, this.params.percentileToCollect).next((function(e) {
            ...
            return a = Date.now(), V() <= f.DEBUG && U("LruGarbageCollector", "LRU Garbage Collection\n\tCounted targets in " + (o - h) + "ms\n\tDetermined least recently used " + r + " in " + (s - o) + "ms\n\tRemoved " + i + " targets in " + (u - s) + "ms\n\tRemoved " + t + " documents in " + (a - u) + "ms\nTotal Duration: " + (a - h) + "ms"), 
            zr.resolve({
                didRun: !0,
    ...
    t.prototype.Ae = function(t, e) {
        return function(t, e) {
            var n = !1;
            return Ri(t).Qt((function(r) {
                return Ni(t, r, e).next((function(t) {
                    return t && (n = !0), zr.resolve(!t);
                }));
            })).next((function() {
                return n;
            }));
        ...
        return this.Ie(t, (function(s, u) {
            if (u <= e) {
                var a = n.Ae(t, s).next((function(e) {
                    if (!e) 
 ...
 */ var zi = /** @class */ function() {
    ...
    t.prototype.delete = function(t) {
        ...
        return vt(this.inner);
    }, t;
}(), Qi = /** @class */ function() {
    function t() {
        // A mapping of document key to the new cache entry that should be written (or null if any
        // existing cache entry should be removed).
        this.changes = new zi((function(t) {
            return t.toString();
        }), (function(t, e) {
            return t.isEqual(e);
    ...
    t.prototype.getEntry = function(t, e) {
        ...
        return void 0 !== n ? zr.resolve(n.document) : this.getFromCache(t, e);
    }, 
    /**
    ...
    t.prototype.updateMetadata = function(t, e) {
        ...
        var n = this;
        return Ji(t).get(Xi(e)).next((function(t) {
            return n.be(e, t);
        }));
    }, 
    /**
    ...
    t.prototype.Ve = function(t, e) {
        var n = this, r = _n(), i = new wn(Pt.comparator);
        return this.ve(t, e, (function(t, e) {
            var o = n.be(t, e);
        ...
        if (e.isEmpty()) return zr.resolve();
        var r = IDBKeyRange.bound(e.first().path.toArray(), e.last().path.toArray()), i = e.getIterator(), o = i.getNext();
        return Ji(t).jt({
            range: r
        }, (function(t, e, r) {
            // Go through keys not found in cache.
            for (var s = Pt.fromSegments(t); o && Pt.comparator(o, s) < 0; ) n(o, null), o = i.getNext();
            o && o.isEqual(s) && (
            // Key found in cache.
        ...
        var r = this, i = _n(), o = e.path.length + 1, s = {};
        if (n.isEqual(dt.min())) {
        ...
        return Yi(t).get(Pr.key).next((function(t) {
            return z(!!t), t;
        }));
    }, t.prototype.Re = function(t, e) {
        return Yi(t).put(Pr.key, e);
    }, 
    /**
 ...
 */ function Yi(t) {
    return ni(t, Pr.store);
}

/**
 * Helper to get a typed SimpleDbStore for the remoteDocuments object store.
 */ function Ji(t) {
    return ni(t, Lr.store);
}
 ...
 * limitations under the License.
 */
/** Performs database creation and schema upgrades. */ var $i = /** @class */ function() {
    function t(t) {
        this.k = t;
    }
    /**
     ...
     */    return t.prototype.Nt = function(t, e, n, r) {
        var i = this;
        z(n < r && n >= 0 && r <= 11);
        var o = new Qr("createOrUpgrade", e);
        n < 1 && r >= 1 && (function(t) {
     ...
     */
        ...
        s = s.next((function() {
            return function(t, e) {
                return e.store(Nr.store).Bt().next((function(n) {
            ...
            !function(t) {
                ...
                var e = t.objectStore(Lr.store);
                e.createIndex(Lr.readTimeIndex, Lr.readTimeIndexPath, {
                    unique: !1
                }), e.createIndex(Lr.collectionReadTimeIndex, Lr.collectionReadTimeIndexPath, {
                    unique: !1
                });
            }(e);
        ...
        var e = 0;
        return t.store(Lr.store).jt((function(t, n) {
            e += ki(n);
        })).next((function() {
            var n = new Pr(e);
        ...
        var e = this, n = t.store(Dr.store), r = t.store(Nr.store);
        return n.Bt().next((function(n) {
            return zr.forEach(n, (function(n) {
                var i = IDBKeyRange.bound([ n.userId, -1 ], [ n.userId, n.lastAcknowledgedBatchId ]);
                return r.Bt(Nr.userMutationsIndex, i).next((function(r) {
                    return zr.forEach(r, (function(r) {
                        z(r.userId === n.userId);
                        var i = di(e.k, r);
    ...
    t.prototype.xe = function(t) {
        ...
        var n = e.store(Vr.store), r = new Ii, i = function(t) {
            if (r.add(t)) {
        ...
        // Index existing remote documents.
                return e.store(Lr.store).jt({
            Kt: !0
        }, (function(t, e) {
            var n = new gt(t);
            return i(n.popLast());
        })).next((function() {
            return e.store(Cr.store).jt({
                Kt: !0
            }, (function(t, e) {
                t[0];
                var n = t[1];
...
var to = "Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.", eo = /** @class */ function() {
    ...
    h) {
        ...
        this.Me = o, this.window = s, this.document = u, this.Fe = c, this.Le = h, this.Be = null, 
        ...
        }, !t.Pt()) throw new Y(H.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
        this.referenceDelegate = new Ki(this, i), this.Ge = n + "main", this.k = new si(a), 
        this.ze = new Wr(this.Ge, 11, new $i(this.k)), this.He = new Pi(this.referenceDelegate, this.k), 
        this.Jt = new Ti, this.Je = function(t, e) {
            return new Wi(t, e);
        }(this.k, this.Jt), this.Ye = new mi, this.window && this.window.localStorage ? this.Xe = this.window.localStorage : (this.Xe = null, 
        !1 === h && B("IndexedDbPersistence", "LocalStorage is unavailable. As a result, persistence may not work reliably. In particular enablePersistence() could fail immediately after refreshing the page."));
    }
    /**
     ...
     */    return t.prototype.start = function() {
        ...
        // do.
            ...
            throw new Y(H.FAILED_PRECONDITION, to);
    ...
    t.prototype.Ze = function() {
        ...
        return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (function(e) {
            return ro(e).put(new qr(t.clientId, Date.now(), t.networkEnabled, t.inForeground)).next((function() {
                ...
                return t.isPrimary && !n ? t.cn(e).next((function() {
                    return !1;
        ...
        var e = this;
        return no(t).get(kr.key).next((function(t) {
            return zr.resolve(e.un(t));
        }));
                    ...
                    [ 4 /*yield*/ , this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", (function(t) {
                        ...
                        return e.Bt().next((function(t) {
                            ...
                            // Delete metadata for clients that are no longer considered active.
                                                        return zr.forEach(r, (function(t) {
    ...
    t.prototype.on = function(t) {
        var e = this;
        return this.Le ? zr.resolve(!0) : no(t).get(kr.key).next((function(n) {
            ...
            return !(!e.networkEnabled || !e.inForeground) || ro(t).Bt().next((function(t) {
            ...
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    this.yn(), [ 4 /*yield*/ , this.ze.runTransaction("shutdown", "readwrite", [ kr.store, qr.store ], (function(e) {
                        var n = new ei(e, st.I);
                        return t.cn(n).next((function() {
                            return t.hn(n);
                        }));
                    })) ];
    ...
    t.prototype.Tn = function() {
        ...
        return this.runTransaction("getActiveClients", "readonly", (function(e) {
            return ro(e).Bt().next((function(e) {
        ...
        return this.ze.runTransaction(t, o, jr, (function(o) {
            return i = new ei(o, r.Be ? r.Be.next() : st.I), "readwrite-primary" === e ? r.rn(i).next((function(t) {
                return !!t || r.on(i);
            })).next((function(e) {
    ...
    t.prototype.En = function(t) {
        var e = this;
        return no(t).get(kr.key).next((function(t) {
            if (null !== t && e.fn(t.leaseTimestampMs, 5e3) && !e._n(t.ownerId) && !e.un(t) && !(e.Le || e.allowTabSynchronization && t.allowTabSynchronization)) throw new Y(H.FAILED_PRECONDITION, to);
        }));
    }, 
    /**
    ...
    t.prototype.an = function(t) {
        ...
        return no(t).put(kr.key, e);
    }, t.Pt = function() {
        return Wr.Pt();
    }, 
    /** Checks the primary lease and removes it if we are the current primary. */ t.prototype.cn = function(t) {
        var e = this, n = no(t);
        return n.get(kr.key).next((function(t) {
            return e.un(t) ? (U("IndexedDbPersistence", "Releasing primary lease."), n.delete(kr.key)) : zr.resolve();
        }));
    }, 
    ...
    t.prototype.en = function() {
        ...
        "function" == typeof (null === (t = this.window) || void 0 === t ? void 0 : t.addEventListener) && (this.qe = function() {
            ...
            e.mn(), p() && navigator.appVersion.match(/Version\/1[45]/) && 
 ...
 */
function no(t) {
    return ni(t, kr.store);
}

/**
 * Helper to get a typed SimpleDbStore for the client metadata object store.
 */ function ro(t) {
    return ni(t, qr.store);
}
 ...
 */
        return function(t) {
            return Pt.isDocumentKey(t.path) && null === t.collectionGroup && 0 === t.filters.length;
        }(e) ? this.Sn(t, e.path) : _e(e) ? this.Dn(t, e, n) : this.Cn(t, e, n);
    }, t.prototype.Sn = function(t, e) {
        // Just do a simple document lookup.
        return this.Rn(t, new Pt(e)).next((function(t) {
            var e = kn();
        ...
        return this.Jt.getCollectionParents(t, i).next((function(s) {
            return zr.forEach(s, (function(s) {
                var u = function(t, e) {
                    return new ge(e, 
                    /*collectionGroup=*/ null, t.explicitOrderBy.slice(), t.filters.slice(), t.limit, t.limitType, t.startAt, t.endAt);
                }(e, s.child(i));
                return r.Cn(t, u, n).next((function(t) {
                    t.forEach((function(t, e) {
                        o = o.insert(t, e);
                    }));
                }));
        ...
        // Query the remote documents and overlay mutations.
            ...
            return i = e, o.Nn(t, i, r).next((function(t) {
                ...
                for (var e = 0, n = i; e < n.length; e++) for (var o = n[e], s = 0, u = o.mutations; s < u.length; s++) {
                    ...
                    h = Xt.newInvalidDocument(c), r = r.insert(c, h)), nn(a, h, o.localWriteTime), h.isFoundDocument() || (r = r.remove(c));
                }
            }));
        })).next((function() {
        ...
        for (var r = xn(), i = 0, o = e; i < o.length; i++) for (var s = 0, u = o[i].mutations; s < u.length; s++) {
            var a = u[s];
    ...
    return t.$n = function(e, n) {
        for (var r = xn(), i = xn(), o = 0, s = n.docChanges; o < s.length; o++) {
            var u = s[o];
            switch (u.type) {
              case 0 /* Added */ :
                r = r.add(u.doc.key);
    ...
    t, e, n, r) {
        ...
        /**
             ...
             */
        this.jn = dt.min(), this.An = t.getMutationQueue(n), this.Qn = t.getRemoteDocumentCache(), 
        this.He = t.getTargetCache(), this.Wn = new so(this.Qn, this.An, this.persistence.getIndexManager()), 
...
function fo(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = W(t), i = n.An, o = n.Wn, [ 4 /*yield*/ , n.persistence.runTransaction("Handle user change", "readonly", (function(t) {
                    ...
                    return n.An.getAllMutationBatches(t).next((function(s) {
                        ...
                        // MutationQueue.
                        o = new so(n.Qn, i, n.persistence.getIndexManager()), i.getAllMutationBatches(t);
                    })).next((function(e) {
                        for (var n = [], i = [], s = xn(), u = 0, a = r
              ...
              case 1:
                return s = r.sent(), [ 2 /*return*/ , (n.An = i, n.Wn = o, n.Un.On(n.Wn), s) ];
            }
        }));
    }));
}
 ...
 */ function lo(t, e) {
    ...
    return n.persistence.runTransaction("Acknowledge batch", "readwrite-primary", (function(t) {
        ...
        return function(t, e, n, r) {
            var i = n.batch, o = i.keys(), s = zr.resolve();
 ...
 * queue.
 */ function yo(t, e) {
    var n = W(t), r = e.snapshotVersion, i = n.qn;
    return n.persistence.runTransaction("Apply remote event", "readwrite-primary", (function(t) {
        ...
        e.targetChanges.forEach((function(o, u) {
            ...
            if (a) {
                ...
                s.push(n.He.removeMatchingKeys(t, o.removedDocuments, u).next((function() {
                    return n.He.addMatchingKeys(t, o.addedDocuments, u);
                })));
                var c = a.withSequenceNumber(t.currentSequenceNumber);
                e.targetMismatches.has(u) ? c = c.withResumeToken(Et.EMPTY_BYTE_STRING, dt.min()).withLastLimboFreeSnapshotVersion(dt.min()) : o.resumeToken.approximateByteSize() > 0 && (c = c.withResumeToken(o.resumeToken, r)), 
                i = i.insert(u, c), 
     ...
     */
                ...
                }(a, c, o) && s.push(n.He.updateTargetData(t, c));
            }
        }));
        var u = _n();
        ...
        s.push(vo(t, o, e.documentUpdates, r, void 0).next((function(t) {
            u = t;
        }))), !r.isEqual(dt.min())) {
            var a = n.He.getLastRemoteSnapshotVersion(t).next((function(e) {
                return n.He.setTargetsMetadata(t, t.currentSequenceNumber, r);
            }));
            s.push(a);
        }
        return zr.waitFor(s).next((function() {
            return o.apply(t);
        })).next((function() {
            return n.Wn.Vn(t, u);
        })).next((function() {
...
i) {
    ...
    return n.forEach((function(t) {
        ...
        return n.forEach((function(n, s) {
            ...
            // cache.
                        s.isNoDocument() && s.version.isEqual(dt.min()) ? (
            ...
            o = o.insert(n, s)) : U("LocalStore", "Ignoring outdated watch update for ", n, ". Current version:", u.version, " Watch version:", s.version);
        })), o;
    }))
    /**
 ...
 */ function go(t, e) {
    ...
    return n.persistence.runTransaction("Allocate target", "readwrite", (function(t) {
        ...
        return n.He.getTargetData(t, e).next((function(i) {
            ...
            r = i, zr.resolve(r)) : n.He.allocateTargetId(t).next((function(i) {
                return r = new oi(e, i, 0 /* Listen */ , t.currentSequenceNumber), n.He.addTargetData(t, r).next((function() {
                    return r;
                }));
            }));
        }));
...
function wo(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                n = W(t), o = n.qn.get(e), s = i ? "readwrite" : "readwrite-primary", r.label = 1;
              ...
              case 4:
                if (!Jr(u = r.sent())) throw u;
                // All `releaseTarget` does is record the final metadata state for the
                // target, but we've been recording this periodically during target
                // activity. If we lose this write this could cause a very slight
                // difference in the order of target deletion during GC, but we
                // don't define exact LRU semantics so this is acceptable.
                                return U("LocalStore", "Failed to update sequence numbers for target " + e + ": " + u), 
                [ 3 /*break*/ , 5 ];
 ...
 */ function bo(t, e, n) {
    var r = W(t), i = dt.min(), o = xn();
    return r.persistence.runTransaction("Execute query", "readonly", (function(t) {
        return function(t, e, n) {
            var r = W(t), i = r.Kn.get(n);
            return void 0 !== i ? zr.resolve(r.qn.get(i)) : r.He.getTargetData(e, n);
            ...
            return r.Un.getDocumentsMatchingQuery(t, e, n ? i : dt.min(), n ? o : xn());
        })).next((function(t) {
            return {
                documents: t,
                zn: o
...
// PORTING NOTE: Multi-Tab only.
function Io(t, e) {
    var n = W(t), r = W(n.He), i = n.qn.get(e);
...
function To(t) {
    ...
    return e.persistence.runTransaction("Get new document changes", "readonly", (function(t) {
        return function(t, e, n) {
            var r = W(t), i = _n(), o = ci(n), s = Ji(e), u = IDBKeyRange.lowerBound(o, !0);
            return s.jt({
...
function Eo(t) {
    return n(this, void 0, void 0, (function() {
        var e;
        return r(this, (function(n) {
            return [ 2 /*return*/ , (e = W(t)).persistence.runTransaction("Synchronize last document change read time", "readonly", (function(t) {
                return function(t) {
                    var e = Ji(t), n = dt.min();
                    // If there are no existing entries, we return SnapshotVersion.min().
                        ...
                        e.readTime && (n = hi(e.readTime)), r.done();
                    })).next((function() {
                        return n;
                    }));
                }(t);
 ...
 */ function So(t, e, i, o) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                for (n = W(t), s = xn(), u = _n(), a = Nn(), c = 0, h = i; c < h.length; c++) f = h[c], 
                l = e.Hn(f.metadata.name), f.document && (s = s.add(l)), u = u.insert(l, e.Jn(f)), 
                a = a.insert(l, e.Yn(f.metadata.readTime));
                return d = n.Qn.newChangeBuffer({
                    trackRemovals: !0
                }), [ 4 /*yield*/ , go(n, function(t) {
                    // It is OK that the path used for the query is not valid, because this will
                    // not be read and queried.
                    return ke(be(gt.fromString("__bundle__/docs/" + t)));
                }(o)) ];
              ...
              case 1:
                ...
                return p = r.sent(), [ 2 /*return*/ , n.persistence.runTransaction("Apply bundle documents", "readwrite", (function(t) {
                    return vo(t, d, u, dt.min(), a).next((function(e) {
                        return d.apply(t), e;
                    })).next((function(e) {
 ...
 */ function _o(t, e, i) {
    return void 0 === i && (i = xn()), n(this, void 0, void 0, (function() {
        var n, o;
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return [ 4 /*yield*/ , go(t, ke(vi(e.bundledQuery))) ];
              ...
              case 1:
                return n = r.sent(), [ 2 /*return*/ , (o = W(t)).persistence.runTransaction("Save named query", "readwrite", (function(t) {
                    ...
                    // Update existing target data because the query from the bundle is newer.
                                        var s = n.withResumeToken(Et.EMPTY_BYTE_STRING, r);
 ...
 */ var Ao = /** @class */ function() {
    ...
    return t.prototype.getBundleMetadata = function(t, e) {
        return zr.resolve(this.Xn.get(e));
    }, t.prototype.saveBundleMetadata = function(t, e) {
        ...
        return this.Xn.set(e.id, {
            id: (n = e).id,
            version: n.version,
            createTime: Yn(n.createTime)
        }), zr.resolve();
    }, t.prototype.getNamedQuery = function(t, e) {
        return zr.resolve(this.Zn.get(e));
    }, t.prototype.saveNamedQuery = function(t, e) {
        return this.Zn.set(e.name, function(t) {
            return {
                name: t.name,
                query: vi(t.bundledQuery),
                readTime: Yn(t.readTime)
            };
        }(e)), zr.resolve();
    }, t;
}(), ko = /** @class */ function() {
    function t() {
        ...
        this.ts = new Tn(Do.es), 
        // A set of outstanding references to a document sorted by target id.
        this.ns = new Tn(Do.ss)
    ...
    t.prototype.us = function(t) {
        var e = this, n = new Pt(new gt([])), r = new Do(n, t), i = new Do(n, t + 1), o = [];
        ...
        var e = new Pt(new gt([])), n = new Do(e, t), r = new Do(e, t + 1), i = xn();
        return this.ns.forEachInRange([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.containsKey = function(t) {
        var e = new Do(t, 0), n = this.ts.firstAfterOrEqual(e);
    ...
    return t.es = function(t, e) {
        return Pt.comparator(t.key, e.key) || ct(t.fs, e.fs);
    }, 
    /** Compare by ID then by key */ t.ss = function(t, e) {
        return ct(t.fs, e.fs) || Pt.comparator(t.key, e.key);
    }, t;
}(), No = /** @class */ function() {
    function t(t, e) {
        ...
        this.ws = new Tn(Do.es);
    }
    return t.prototype.checkEmpty = function(t) {
        return zr.resolve(0 === this.An.length);
    }, t.prototype.addMutationBatch = function(t, e, n, r) {
        var i = this.ds;
        ...
        for (var s = 0, u = r; s < u.length; s++) {
            var a = u[s];
            this.ws = this.ws.add(new Do(a.key, i)), this.Jt.addToCollectionParentIndex(t, a.key.path.popLast());
        }
        return zr.resolve(o);
    }, t.prototype.lookupMutationBatch = function(t, e) {
        return zr.resolve(this._s(e));
    }, t.prototype.getNextMutationBatchAfterBatchId = function(t, e) {
        var n = e + 1, r = this.gs(n), i = r < 0 ? 0 : r;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return zr.resolve(this.An.length > i ? this.An[i] : null);
    }, t.prototype.getHighestUnacknowledgedBatchId = function() {
        return zr.resolve(0 === this.An.length ? -1 : this.ds - 1);
    }, t.prototype.getAllMutationBatches = function(t) {
        return zr.resolve(this.An.slice());
    }, t.prototype.getAllMutationBatchesAffectingDocumentKey = function(t, e) {
        var n = this, r = new Do(e, 0), i = new Do(e, Number.POSITIVE_INFINITY), o = [];
        return this.ws.forEachInRange([ r, i ], (function(t) {
            var e = n._s(t.fs);
            o.push(e);
        })), zr.resolve(o);
    }, t.prototype.getAllMutationBatchesAffectingDocumentKeys = function(t, e) {
        var n = this, r = new Tn(ct);
        return e.forEach((function(t) {
            var e = new Do(t, 0), i = new Do(t, Number.POSITIVE_INFINITY);
            n.ws.forEachInRange([ e, i ], (function(t) {
                r = r.add(t.fs);
            }));
        })), zr.resolve(this.ys(r));
    }, t.prototype.getAllMutationBatchesAffectingQuery = function(t, e) {
        ...
        var o = new Do(new Pt(i), 0), s = new Tn(ct);
        ...
        var n = this;
        z(0 === this.ps(e.batchId, "removed")), this.An.shift();
        var r = this.ws;
        return zr.forEach(e.mutations, (function(i) {
            var o = new Do(i.key, e.batchId);
        ...
        var n = new Do(e, 0), r = this.ws.firstAfterOrEqual(n);
        return zr.resolve(e.isEqual(r && r.key));
    }, t.prototype.performConsistencyCheck = function(t) {
        return this.An.length, zr.resolve();
    }, 
    /**
    ...
    t.prototype.removeEntry = function(t) {
        ...
        return zr.resolve(n ? n.document.mutableCopy() : Xt.newInvalidDocument(e));
    }, t.prototype.getEntries = function(t, e) {
        var n = this, r = _n();
        return e.forEach((function(t) {
            var e = n.docs.get(t);
            r = r.insert(t, e ? e.document.mutableCopy() : Xt.newInvalidDocument(t));
        })), zr.resolve(r);
    }, t.prototype.getDocumentsMatchingQuery = function(t, e, n) {
        for (var r = _n(), i = new Pt(e.path.child("")), o = this.docs.getIteratorFrom(i)
        // Documents are ordered by key, so we can use a prefix scan to narrow down
        // the documents we need to match the query against.
        ; o.hasNext(); ) {
            var s = o.getNext(), u = s.key, a = s.value, c = a.document, h = a.readTime;
            if (!e.path.isPrefixOf(u.path)) break;
            h.compareTo(n) <= 0 || Re(e, c) && (r = r.insert(c.key, c.mutableCopy()));
        }
        return zr.resolve(r);
    }, t.prototype.Es = function(t, e) {
        return zr.forEach(this.docs, (function(t) {
            return e(t);
        }));
    }, t.prototype.newChangeBuffer = function(t) {
...
}(Qi), Ro = /** @class */ function() {
    function t(t) {
        this.persistence = t, 
        /**
             * Maps a target to the data about that target
             */
        this.Is = new zi((function(t) {
            return te(t);
        }), ee), 
        ...
        /**
             ...
             * IDs.
             */
        this.Rs = new ko, this.targetCount = 0, this.bs = Li.ie();
    }
    return t.prototype.forEachTarget = function(t, e) {
        ...
        return zr.resolve(this.lastRemoteSnapshotVersion);
    }, t.prototype.getHighestSequenceNumber = function(t) {
        return zr.resolve(this.As);
    }, t.prototype.allocateTargetId = function(t) {
        return this.highestTargetId = this.bs.next(), zr.resolve(this.highestTargetId);
    }, t.prototype.setTargetsMetadata = function(t, e, n) {
        ...
        var e = t.targetId;
        e > this.highestTargetId && (this.bs = new Li(e), this.highestTargetId = e), t.sequenceNumber > this.As && (this.As = t.sequenceNumber);
    }, t.prototype.addTargetData = function(t, e) {
        return this.ae(e), this.targetCount += 1, zr.resolve();
    }, t.prototype.updateTargetData = function(t, e) {
        return this.ae(e), zr.resolve();
    }, t.prototype.removeTargetData = function(t, e) {
        return this.Is.delete(e.target), this.Rs.us(e.targetId), this.targetCount -= 1, 
        zr.resolve();
    }, t.prototype.removeTargets = function(t, e, n) {
        var r = this, i = 0, o = [];
        return this.Is.forEach((function(s, u) {
            u.sequenceNumber <= e && null === n.get(u.targetId) && (r.Is.delete(s), o.push(r.removeMatchingKeysForTargetId(t, u.targetId)), 
            i++);
        })), zr.waitFor(o).next((function() {
            return i;
        }));
    }, t.prototype.getTargetCount = function(t) {
        return zr.resolve(this.targetCount);
    }, t.prototype.getTargetData = function(t, e) {
        var n = this.Is.get(e) || null;
        return zr.resolve(n);
    }, t.prototype.addMatchingKeys = function(t, e, n) {
        return this.Rs.rs(e, n), zr.resolve();
    }, t.prototype.removeMatchingKeys = function(t, e, n) {
        this.Rs.cs(e, n);
        ...
        return this.Rs.us(e), zr.resolve();
    }, t.prototype.getMatchingKeysForTargetId = function(t, e) {
        var n = this.Rs.ls(e);
        return zr.resolve(n);
    }, t.prototype.containsKey = function(t, e) {
        return zr.resolve(this.Rs.containsKey(e));
    }, t;
}(), Lo = /** @class */ function() {
    /**
    ...
    function t(t, e) {
        ...
        this.He = new Ro(this), this.Jt = new bi, this.Je = function(t, e) {
            return new Co(t, (function(t) {
                return n.referenceDelegate.vs(t);
            }));
        }(this.Jt), this.k = new si(e), this.Ye = new Ao(this.k);
    }
    return t.prototype.start = function() {
        return Promise.resolve();
    }, t.prototype.shutdown = function() {
        ...
        return e || (e = new No(this.Jt, this.referenceDelegate), this.Ps[t.toKey()] = e), 
        e;
    }, t.prototype.getTargetCache = function() {
        return this.He;
    }, t.prototype.getRemoteDocumentCache = function() {
        ...
        return zr.or(Object.values(this.Ps).map((function(n) {
            return function() {
    ...
    return t.ks = function(e) {
        ...
        return this.Cs.addReference(n, e), this.xs.delete(n.toString()), zr.resolve();
    }, t.prototype.removeReference = function(t, e, n) {
        return this.Cs.removeReference(n, e), this.xs.add(n.toString()), zr.resolve();
    }, t.prototype.markPotentiallyOrphaned = function(t, e) {
        return this.xs.add(e.toString()), zr.resolve();
    }, t.prototype.removeTarget = function(t, e) {
        var n = this;
        ...
        // Remove newly orphaned documents.
                return zr.forEach(this.xs, (function(r) {
            var i = Pt.fromPath(r);
        ...
        var n = this;
        return zr.or([ function() {
            return zr.resolve(n.Cs.containsKey(e));
        }, function() {
...
/** Assembles the key for a query state in WebStorage */ function Vo(t, e) {
...
var qo = /** @class */ function() {
    ...
    return t.Os = function(e, n) {
        for (var r = JSON.parse(n), i = "object" == typeof r && r.activeTargetIds instanceof Array, o = Ln(), s = 0; i && s < r.activeTargetIds.length; ++s) i = Lt(r.activeTargetIds[s]), 
    ...
    function t(t, e, n, r, i) {
        ...
        }(this.persistenceKey), this.Ks = this.Ks.insert(this.Bs, new Ko), this.Gs = new RegExp("^firestore_clients_" + o + "_([^_]*)$"), 
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 1:
                    ...
                    for (this.Xs(), (u = this.storage.getItem(this.Js)) && (a = this.Zs(u)) && this.ti(a), 
                    ...
                    return r(this, (function(r) {
                        if (this.started) {
                            if (null !== i.key) if (this.Gs.test(i.key)) {
                                if (null == i.newValue) return t = this.ai(i.key), [ 2 /*return*/ , this.ui(t, null) ];
                            ...
                            } else if (i.key === this.Ws) u = function(t) {
                                var e = st.I;
                                if (null != t) try {
                                    var n = JSON.parse(t);
                                ...
                                return e;
                            }(i.newValue), u !== st.I && this.sequenceNumberHandler(u); else if (i.key === this.Ys) return [ 2 /*return*/ , this.syncEngine._i() ];
                        } else this.js.push(i);
                        return [ 2 /*return*/ ];
                    }));
                }));
    ...
    t.prototype.Zs = function(t) {
        ...
        return n(this, void 0, void 0, (function() {
            return r(this, (function(e) {
                return t.user.uid === this.currentUser.uid ? [ 2 /*return*/ , this.syncEngine.mi(t.batchId, t.state, t.error) ] : (U("SharedClientState", "Ignoring mutation for non-active user " + t.user.uid), 
                [ 2 /*return*/ ]);
            }));
        }));
        ...
        var n = this, r = e ? this.Ks.insert(t, e) : this.Ks.remove(t), i = this.ei(this.Ks), o = this.ei(r), s = [], u = [];
        return o.forEach((function(t) {
            i.has(t) || s.push(t);
        })), i.forEach((function(t) {
            o.has(t) || u.push(t);
        })), this.syncEngine.yi(s, u).then((function() {
            n.Ks = r;
        }));
    ...
    function t() {
        this.pi = new Ko, this.Ti = {}, this.onlineStateHandler = null, this.sequenceNumberHandler = null;
    }
    return t.prototype.addPendingMutation = function(t) {
        ...
        return this.pi = new Ko, Promise.resolve();
    }, t.prototype.handleUserChange = function(t, e, n) {
        // No op.
    }, t.prototype.setOnlineState = function(t) {
        // No op.
    ...
    return t(n, e), n.prototype.Ki = function(t, e, n, r) {
        return new Promise((function(i, o) {
            var s = new _;
            s.listenOnce(A.COMPLETE, (function() {
                try {
                    switch (s.getLastErrorCode()) {
                      ...
                      case k.HTTP_ERROR:
                        var n = s.getStatus();
                        if (U("Connection", 'RPC "' + t + '" failed with status:', n, "response text:", s.getResponseText()), 
                        n > 0) {
                            ...
                            if (r && r.status && r.message) {
                                ...
                                o(new Y(u, r.message));
                            } else o(new Y(H.UNKNOWN, "Server responded with status " + s.getStatus()));
                        } else 
        ...
        this.useFetchStreams && (s.xmlHttpFactory = new C({})), this.qi(s.initMessageHeaders, e, n), 
        ...
        y() || v() || m() || g() || w() || b() || (s.httpHeadersOverwriteParam = "$httpHeaders");
        var u = r.join("");
        U("Connection", "Creating WebChannel: " + u, s);
        var a = i.createWebChannel(u, s), c = !1, h = !1, f = new Yo({
            Vi: function(t) {
                h ? U("Connection", "Not sending because WebChannel is closed:", t) : (c || (U("Connection", "Opening WebChannel transport."), 
        ...
        return l(a, x.EventType.OPEN, (function() {
            h || U("Connection", "WebChannel transport opened.");
        })), l(a, x.EventType.CLOSE, (function() {
            h || (h = !0, U("Connection", "WebChannel transport closed"), f.Oi());
        })), l(a, x.EventType.ERROR, (function(t) {
            h || (h = !0, j("Connection", "WebChannel transport errored:", t), f.Oi(new Y(H.UNAVAILABLE, "The operation could not be completed")));
        })), l(a, x.EventType.MESSAGE, (function(t) {
            var e;
            if (!h) {
                var n = t.data[0];
                z(!!n);
 ...
 */
    ...
    return t.prototype.Bi = function(t, e, n, r, i) {
        ...
        return this.qi(s, r, i), this.Ki(t, o, s, n).then((function(t) {
            ...
            throw j("RestConnection", t + " failed with error: ", e, "url: ", o, "request:", n), 
            e;
        }));
...
/** The Platform's 'document' implementation or null if not available. */ function $o() {
 ...
 * limitations under the License.
 */ function Zo(t) {
    return new zn(t, /* useProto3Json= */ !0);
}
 ...
 */ var ts = /** @class */ function() {
    ...
    function t(t, e, n, r, i, o, s, u) {
        ...
        this.appCheckCredentialsProvider = s, this.listener = u, this.state = 0 /* Initial */ , 
        /**
             * A close count that's incremented every time the stream is closed; used by
             * getCloseGuardedDispatcher() to invalidate callbacks that happen after
             * close.
             */
        this.rr = 0, this.cr = null, this.ar = null, this.stream = null, this.ur = new ts(t, e)
        /**
    ...
    t.prototype._r = function() {
        ...
        // running a timer (in which case the previous idle timeout still applies).
                this.lr() && null === this.cr && (this.cr = this.Me.enqueueAfterDelay(this.nr, 6e4, (function() {
            return t.mr();
        })));
    }, 
            ...
            return r(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    this.ur.reset() : e && e.code === H.RESOURCE_EXHAUSTED ? (
                    // Log the error. (Probably either 'quota exceeded' or 'max queue length reached'.)
                    B(e.toString()), B("Using maximum backoff delay to prevent overloading the backend."), 
                    this.ur.Xi()) : e && e.code === H.UNAUTHENTICATED && 3 /* Healthy */ !== this.state && (
    ...
    t.prototype.Tr = function() {}, t.prototype.auth = function() {
        ...
        this.stream = this.Rr(t, e), this.stream.Di((function() {
            r((function() {
                return n.state = 2 /* Open */ , n.ar = n.Me.enqueueAfterDelay(n.sr, 1e4, (function() {
    ...
    function n(t, n, r, i, o, s) {
        var u = this;
        return (u = e.call(this, t, "listen_stream_connection_backoff" /* ListenStreamConnectionBackoff */ , "listen_stream_idle" /* ListenStreamIdle */ , "health_check_timeout" /* HealthCheckTimeout */ , n, r, i, s) || this).k = o, 
        u;
    }
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var r = function(t) {
                    ...
                    return t.C ? (z(void 0 === e || "string" == typeof e), Et.fromBase64String(e || "")) : (z(void 0 === e || e instanceof Uint8Array), 
                ...
                n = new Vn(r, i, o, u || null);
            } else if ("documentChange" in e) {
                e.documentChange;
                var a = e.documentChange;
                a.document, a.document.name, a.document.updateTime;
                var c = Zn(t, a.document.name), h = Yn(a.document.updateTime), f = new Yt({
                    mapValue: {
                        fields: a.document.fields
                    }
                }), l = Xt.newFoundDocument(c, h, f), d = a.targetIds || [], p = a.removedTargetIds || [];
                n = new Mn(d, p, l.key, l);
            } else if ("documentDelete" in e) {
                e.documentDelete;
                var y = e.documentDelete;
                y.document;
                var v = Zn(t, y.document), m = y.readTime ? Yn(y.readTime) : dt.min(), g = Xt.newNoDocument(v, m), w = y.removedTargetIds || [];
                n = new Mn([], w, g.key, g);
                ...
                var E = e.filter;
                E.targetId;
                var S = E.count || 0, _ = new vn(S), A = E.targetId;
                n = new Fn(A, _);
            }
            return n;
            ...
            return e.targetIds && e.targetIds.length ? dt.min() : e.readTime ? Yn(e.readTime) : dt.min();
        }(t);
    ...
    n.prototype.Pr = function(t) {
        var e = {};
        e.database = nr(this.k), e.addTarget = function(t, e) {
            var n, r = e.target;
            return (n = ne(r) ? {
                documents: ar(t, r)
            } : {
                query: cr(t, r)
            }).targetId = e.targetId, e.resumeToken.approximateByteSize() > 0 ? n.resumeToken = Wn(t, e.resumeToken) : e.snapshotVersion.compareTo(dt.min()) > 0 && (
    ...
    n.prototype.vr = function(t) {
        var e = {};
        e.database = nr(this.k), e.removeTarget = t, this.gr(e);
    }, n;
}(es), rs = /** @class */ function(e) {
    function n(t, n, r, i, o, s) {
        var u = this;
        return (u = e.call(this, t, "write_stream_connection_backoff" /* WriteStreamConnectionBackoff */ , "write_stream_idle" /* WriteStreamIdle */ , "health_check_timeout" /* HealthCheckTimeout */ , n, r, i, s) || this).k = o, 
        u.Vr = !1, u;
    }
            ...
            var e = function(t, e) {
                return t && t.length > 0 ? (z(void 0 !== e), t.map((function(t) {
                    return function(t, e) {
                        ...
                        var n = t.updateTime ? Yn(t.updateTime) : Yn(e);
                        ...
                        n = Yn(e)), new Xe(n, t.transformResults || []);
                    }(t, e);
                }))) : [];
            }(t.writeResults, t.commitTime), n = Yn(t.commitTime);
    ...
    n.prototype.kr = function() {
        ...
        var t = {};
        t.database = nr(this.k), this.gr(t);
    }, 
...
}(es), is = /** @class */ function(e) {
    function n(t, n, r, i) {
        var o = this;
        return (o = e.call(this) || this).authCredentials = t, o.appCheckCredentials = n, 
        o.ir = r, o.k = i, o.$r = !1, o;
    }
    return t(n, e), n.prototype.Or = function() {
        if (this.$r) throw new Y(H.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
    /** Invokes the provided RPC with auth and AppCheck tokens. */ n.prototype.Bi = function(t, e, n) {
        var r = this;
        return this.Or(), Promise.all([ this.authCredentials.getToken(), this.appCheckCredentials.getToken() ]).then((function(i) {
            var o = i[0], s = i[1];
        ...
        i.enqueueAndForget((function() {
            return n(u, void 0, void 0, (function() {
                return r(this, (function(t) {
                    switch (t.label) {
                      case 0:
                        return ys(this) ? (U("RemoteStore", "Restarting streams for network reachability change."), 
                        [ 4 /*yield*/ , function(t) {
                            return n(this, void 0, void 0, (function() {
                                var e;
                                return r(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = W(t)).Gr.add(4 /* ConnectivityChange */), [ 4 /*yield*/ , as(e) ];
...
function ws(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(a) {
            switch (a.label) {
              case 0:
                if (t.Jr.set("Online" /* Online */), !(e instanceof Vn && 2 /* Removed */ === e.state && e.cause)) 
              ...
              case 7:
                return a.trys.push([ 7, 11, , 13 ]), [ 4 /*yield*/ , po(t.localStore) ];
                ...
                function(t, e) {
                    ...
                    n.targetMismatches.forEach((function(e) {
                        ...
                        if (n) {
                            ...
                            // state.
                            t.Wr.set(e, n.withResumeToken(Et.EMPTY_BYTE_STRING, n.snapshotVersion)), 
                            ...
                            var r = new oi(n.target, e, 1 /* ExistenceFilterMismatch */ , n.sequenceNumber);
                            fs(t, r);
                        }
              ...
              case 11:
                return U("RemoteStore", "Failed to raise snapshot:", u = a.sent()), [ 4 /*yield*/ , bs(t, u) ];
                    ...
                    return n(o, void 0, void 0, (function() {
                        return r(this, (function(e) {
                            switch (e.label) {
                              ...
                              case 1:
                                return e.sent(), t.Gr.delete(1 /* IndexedDbFailed */), [ 4 /*yield*/ , us(t) ];
 ...
 */ (e)) return [ 3 /*break*/ , 7 ];
              ...
              case 2:
                return r.trys.push([ 2, 4, , 6 ]), [ 4 /*yield*/ , mo(e.localStore, i) ];
              ...
              case 4:
                return s = r.sent(), [ 4 /*yield*/ , bs(e, s) ];
...
function ks(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = t.Qr.shift(), o = ii.from(n, e, i), [ 4 /*yield*/ , Is(t, (function() {
                ...
                return e && Rs(t).Sr ? [ 4 /*yield*/ , function(t, e) {
                    return n(this, void 0, void 0, (function() {
                        ...
                        return r(this, (function(r) {
                            switch (r.label) {
                              case 0:
                                return mn(i = e.code) && i !== H.ABORTED ? (n = t.Qr.shift(), 
 ...
 */ function Cs(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = W(t), e ? (n.Gr.delete(2 /* IsSecondary */), [ 4 /*yield*/ , us(n) ]) : [ 3 /*break*/ , 2 ];
 ...
 */ function xs(t) {
    ...
    t.Xr = function(t, e, n) {
        var r = W(t);
        return r.Or(), new ns(e, r.ir, r.authCredentials, r.appCheckCredentials, r.k, n);
        ...
        return n(e, void 0, void 0, (function() {
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return i ? (t.Xr.wr(), ps(t) ? ds(t) : t.Jr.set("Unknown" /* Unknown */), [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 1 ];
...
function Rs(t) {
    ...
    t.Zr = function(t, e, n) {
        var r = W(t);
        return r.Or(), new rs(e, r.ir, r.authCredentials, r.appCheckCredentials, r.k, n);
    }(t.datastore, t.asyncQueue, {
        Di: _s.bind(null, t),
        Ni: Ds.bind(null, t),
        Nr: As.bind(null, t),
        ...
        return n(e, void 0, void 0, (function() {
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return i ? (t.Zr.wr(), [ 4 /*yield*/ , Ts(t) ]) : [ 3 /*break*/ , 2 ];
                  ...
                  case 3:
                    e.sent(), t.Qr.length > 0 && (U("RemoteStore", "Stopping write stream with " + t.Qr.length + " pending writes"), 
                    t.Qr = []), e.label = 4;
 ...
 */ var Os = /** @class */ function() {
    ...
    function t(t) {
        ...
        }, this.keyedMap = kn(), this.sortedSet = new wn(this.comparator)
        /**
...
function Bs(t, e) {
    return n(this, void 0, void 0, (function() {
        var n, i, o, s, u;
        return r(this, (function(r) {
            return n = W(t), i = e.query, o = !1, (s = n.queries.get(i)) && (u = s.listeners.indexOf(e)) >= 0 && (s.listeners.splice(u, 1), 
 ...
 */ var zs = /** @class */ function() {
    ...
    return t.prototype.oo = function(t) {
        ...
        var o = !1;
        return this.ao ? this.ho(t) && (this.co.next(t), o = !0) : this.lo(t, this.onlineState) && (this.fo(t), 
        o = !0), this.uo = t, o;
    ...
    t.prototype.Jn = function(t) {
        return t.metadata.exists ? or(this.k, t.document, !1) : Xt.newNoDocument(this.Hn(t.metadata.name), this.Yn(t.metadata.readTime));
        ...
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 2:
                    return n < i.length ? (o = i[n], [ 4 /*yield*/ , _o(this.localStore, o, e.get(o.name)) ]) : [ 3 /*break*/ , 5 ];
                  ...
                  case 5:
                    return [ 2 /*return*/ , (this.progress.taskState = "Success", new oo(Object.assign({}, this.progress), t)) ];
                }
            }));
        }));
    }, t;
 ...
 */ var Js = function(t) {
    ...
    t.prototype.Po = function(t, e) {
        ...
        if (t.inorderTraversal((function(t, e) {
            ...
            o = o.delete(t)));
        })), Ie(this.query) || Te(this.query)) for (;s.size > this.query.limit; ) {
    ...
    t.prototype.So = function(t) {
        ...
        // updating many documents.
                var e = this.Io;
        this.Io = xn(), this.Ro.forEach((function(e) {
...
n) {
    ...
    r, i, o) {
        ...
        this.jo = new Map, this.Qo = Li.re(), this.onlineState = "Unknown" /* Unknown */ , 
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return [ 4 /*yield*/ , go(n.localStore, ke(e)) ];
                    ...
                    return function(t, e, i, o) {
                        return n(this, void 0, void 0, (function() {
                            ...
                            return r(this, (function(r) {
                                switch (r.label) {
                                  case 0:
                                    return n = e.view.Po(i), n.Bn ? [ 4 /*yield*/ , bo(t.localStore, e.query, 
            ...
            switch (r.label) {
              ...
              case 1:
                return r.trys.push([ 1, 5, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    var n, r = W(t), i = lt.now(), o = e.reduce((function(t, e) {
                        return t.add(e.key);
                    }), xn());
                    return r.persistence.runTransaction("Locally write mutations", "readwrite", (function(t) {
                        return r.Wn.vn(t, o).next((function(o) {
                            ...
                            var s = [], u = 0, a = e; u < a.length; u++) {
                                ...
                                // exists=true
                                s.push(new an(c.key, h, Jt(h.value.mapValue), $e.exists(!0)));
                            }
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return r.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , yo(n.localStore, e) ];
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                // PORTING NOTE: Multi-tab only.
                return (n = W(t)).sharedClientState.updateQueryState(e, "rejected", i), o = n.Uo.get(e), 
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return r.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , lo(n.localStore, e) ];
                ...
                return r.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    ...
                    return n.persistence.runTransaction("Reject batch", "readwrite-primary", (function(t) {
                        ...
                        return n.An.lookupMutationBatch(t, e).next((function(e) {
                            return z(null !== e), r = e.keys(), n.An.removeMutationBatch(t, e);
                        })).next((function() {
                            return n.An.performConsistencyCheck(t);
                        })).next((function() {
                            return n.Wn.vn(t, r);
 ...
 */ function fu(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                ys((n = W(t)).remoteStore) || U("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                r.label = 1;
...
function wu(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(c) {
            switch (c.label) {
              case 0:
                return o = W(t), s = [], u = [], a = [], o.Mo.isEmpty() ? [ 3 /*break*/ , 3 ] : (o.Mo.forEach((function(t, n) {
                    a.push(o.Go(n, e, i).then((function(t) {
                        if (t) {
                            o.isPrimaryClient && o.sharedClientState.updateQueryState(n.targetId, t.fromCache ? "not-current" : "current"), 
                            s.push(t);
                            var e = uo.$n(n.targetId, t);
                            u.push(e);
                        }
                    })));
              ...
              case 1:
                return c.sent(), o.Oo.br(s), [ 4 /*yield*/ , function(t, e) {
                    return n(this, void 0, void 0, (function() {
                            ...
                            switch (r.label) {
                              ...
                              case 1:
                                return r.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , n.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(t) {
                                    return zr.forEach(e, (function(e) {
                                        return zr.forEach(e.kn, (function(r) {
                                            return n.persistence.referenceDelegate.addReference(t, e.targetId, r);
                                        })).next((function() {
                                            return zr.forEach(e.xn, (function(r) {
                              ...
                              case 4:
                                for (o = 0, s = e; o < s.length; o++) u = s[o], a = u.targetId, u.fromCache || (c = n.qn.get(a), 
                                h = c.snapshotVersion, f = c.withLastLimboFreeSnapshotVersion(h), 
                                // Advance the last limbo free snapshot version
                                n.qn = n.qn.insert(a, f));
                                return [ 2 /*return*/ ];
                            }
                        }));
                    }));
 ...
 */ function Tu(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return [ 4 /*yield*/ , bo((n = W(t)).localStore, e.query, 
                /* usePreviousResults= */ !0) ];
                ...
                return [ 4 /*yield*/ , function(t, e) {
                    ...
                    return n.persistence.runTransaction("Lookup mutation documents", "readonly", (function(t) {
                        return r.Zt(t, e).next((function(e) {
                            return e ? n.Wn.vn(t, e) : zr.resolve(null);
                        }));
                    }));
                }((n = W(t)).localStore, e) ];

              case 1:
                return null === (s = r.sent()) ? [ 3 /*break*/ , 6 ] : "pending" !== i ? [ 3 /*break*/ , 3 ] : [ 4 /*yield*/ , Ts(n.remoteStore) ];
...
function Au(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                n = W(t), i = [], o = [], s = 0, u = e, r.label = 1;

              case 1:
                return s < u.length ? (a = u[s], c = void 0, (h = n.Fo.get(a)) && 0 !== h.length ? [ 4 /*yield*/ , go(n.localStore, ke(h[0])) ] : [ 3 /*break*/ , 7 ]) : [ 3 /*break*/ , 13 ];
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 2:
                return [ 4 /*yield*/ , To(n.localStore) ];
        ...
        return r(this, (function(p) {
            switch (p.label) {
              ...
              case 1:
                ...
                U("SyncEngine", "Adding an already active target " + u), [ 3 /*break*/ , 5 ]) : [ 4 /*yield*/ , Io(n.localStore, u) ]) : [ 3 /*break*/ , 6 ];
              ...
              case 4:
                p.sent(), cs(n.remoteStore, c), p.label = 5;
        ...
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 7:
                    return (u = r.sent()) && i._updateProgress(u), [ 4 /*yield*/ , e.Ho() ];
                  ...
                  case 14:
                    return j("SyncEngine", "Loading bundle failed with " + (c = r.sent())), i._failWith(c), 
                    [ 3 /*break*/ , 15 ];
...
var Pu = /** @class */ function() {
    ...
    return t.prototype.initialize = function(t) {
        ...
        return ho(this.persistence, new ao, t.initialUser, this.k);
    }, t.prototype.Yo = function(t) {
        return new Lo(Oo.ks, this.k);
    ...
    return t(i, e), i.prototype.initialize = function(t) {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 1:
                    return r.sent(), [ 4 /*yield*/ , Eo(this.localStore) ];

                  case 2:
                    return r.sent(), [ 4 /*yield*/ , this.tc.initialize(this, t) ];
                  ...
                  case 4:
                    // Enqueue writes from a previous session
                    return r.sent(), [ 4 /*yield*/ , Ts(this.tc.remoteStore) ];
        ...
        var e = io(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey), n = void 0 !== this.cacheSizeBytes ? _i.withCacheSize(this.cacheSizeBytes) : _i.DEFAULT;
        return new eo(this.synchronizeTabs, e, t.clientId, n, t.asyncQueue, Xo(), $o(), this.k, this.sharedClientState, !!this.forceOwnership);
    ...
    return t(i, e), i.prototype.initialize = function(t) {
        ...
        var e = Xo();
        if (!Go.Pt(e)) throw new Y(H.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
        ...
        return function(t) {
            return n(this, void 0, void 0, (function() {
                ...
                return r(this, (function(n) {
                    switch (n.label) {
                      case 0:
                        return e = W(t), U("RemoteStore", "RemoteStore shutting down."), e.Gr.add(5 /* Shutdown */), 
                        [ 4 /*yield*/ , as(e) ];
 ...
 */ var qu = /** @class */ function() {
    ...
    t.prototype.rc = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return [ 4 /*yield*/ , this.oc() ];

                  case 1:
                    return null === (t = r.sent()) ? [ 2 /*return*/ , null ] : (e = this.ic.decode(t), 
                    n = Number(e), isNaN(n) && this.cc("length string (" + e + ") is not valid number"), 
                    [ 4 /*yield*/ , this.ac(n) ]);
    ...
    /** First index of '{' from the underlying buffer. */ t.prototype.uc = function() {
    ...
    t.prototype.oc = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.uc() < 0 ? [ 4 /*yield*/ , this.hc() ] : [ 3 /*break*/ , 3 ];
                  ...
                  case 3:
                    ...
                    (t = this.uc()) < 0 && this.cc("Reached the end of bundle when a length string is expected."), 
    ...
    t.prototype.ac = function(t) {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.buffer.length < t ? [ 4 /*yield*/ , this.hc() ] : [ 3 /*break*/ , 3 ];

                  case 1:
                    n.sent() && this.cc("Reached the end of bundle when more is expected."), n.label = 2;
                  ...
                  case 3:
                    ...
                    return e = this.ic.decode(this.buffer.slice(0, t)), [ 2 /*return*/ , (this.buffer = this.buffer.slice(t), 
                    e) ];
                }
            }));
        }));
                    ...
                    return [ 4 /*yield*/ , function(t, e) {
                        return n(this, void 0, void 0, (function() {
                            ...
                            return r(this, (function(r) {
                                switch (r.label) {
                                  case 0:
                                    return n = W(t), i = nr(n.k) + "/documents", o = {
                                    ...
                                    return s = r.sent(), u = new Map, s.forEach((function(t) {
                                        var e = function(t, e) {
                                            return "found" in e ? function(t, e) {
                                                ...
                                                var n = Zn(t, e.found.name), r = Yn(e.found.updateTime), i = new Yt({
                                                    mapValue: {
                                                ...
                                                var n = Zn(t, e.missing), r = Yn(e.readTime);
            ...
            return r(this, (function(i) {
                switch (i.label) {
                  case 0:
                    ...
                    t.forEach((function(t, n) {
                        var r = Pt.fromPath(n);
                        e.mutations.push(new yn(r, e.precondition(r)));
    ...
    return t.prototype.run = function() {
        ...
        try {
            ...
            return !xt(e) && e.catch && e.then ? e : (this.deferred.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
        ...
        var e = this;
        this.lc > 0 && this._c(t) ? (this.lc -= 1, this.asyncQueue.enqueueAndForget((function() {
                ...
                return u.sent(), o = i.initialUser, t.setCredentialChangeListener((function(t) {
                    return n(s, void 0, void 0, (function() {
                        return r(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return o.isEqual(t) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , fo(e.localStore, t) ];
 ...
 */ function da(t, e, n, r) {
    ...
    t._setSettings(Object.assign(Object.assign({}, o), {
        ...
        if ("string" == typeof r.mockUserToken) s = r.mockUserToken, u = O.MOCK_USER; else {
            ...
            s = T(r.mockUserToken, null === (i = t._app) || void 0 === i ? void 0 : i.options.projectId);
        ...
        t._authCredentials = new Z(new X(s, u));
    }
}
 ...
 */ var pa = /** @class */ function() {
    ...
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this, t, n, be(r)) || this)._path = r, 
        /** The type of this Firestore reference. */
        i.type = "collection", i;
    }
...
var Ta = /** @class */ function() {
    function t() {
        ...
        this.ur = new ts(this, "async_queue_retry" /* AsyncQueueRetry */), 
        // Visibility handler that triggers an immediate retry of all retryable
        // operations. Meant to speed up recovery when we regain file system access
        // after page comes into foreground.
        this.bc = function() {
            var e = $o();
            e && U("AsyncQueue", "Visibility state changed to " + e.visibilityState), t.ur.er();
        };
        var e = $o();
    ...
    t.prototype.enqueueAndForget = function(t) {
        ...
        // advance the queue even when the operation is not run.
                var n = new J;
        return this.vc((function() {
            return e.yc && e.Ac ? Promise.resolve() : (t().then(n.resolve, n.reject), n.promise);
        })).then((function() {
            return n.promise;
        }));
    ...
    t.prototype.Vc = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(n) {
                switch (n.label) {
                  case 0:
                    if (0 === this.gc.length) return [ 3 /*break*/ , 5 ];
                    n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , this.gc[0]() ];

                  case 2:
                    return n.sent(), this.gc.shift(), this.ur.reset(), [ 3 /*break*/ , 4 ];

                  case 3:
                    if (!Jr(t = n.sent())) throw t;
        ...
        var e = this, n = this.mc.then((function() {
            return e.Ic = !0, t().catch((function(t) {
                e.Ec = t, e.Ic = !1;
                var n = 
                /**
 ...
 */
    ...
    /** Called once a DelayedOperation is run or canceled. */ t.prototype.Sc = function(t) {
                    ...
                    return o.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , function(t) {
                        return n(this, void 0, void 0, (function() {
                            ...
                            return r(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return Wr.Pt() ? (e = t + "main", [ 4 /*yield*/ , Wr.delete(e) ]) : [ 2 /*return*/ , Promise.resolve() ];
                    ...
                    switch (r.label) {
                      ...
                      case 2:
                        return n = r.sent(), [ 2 /*return*/ , (e.setNetworkEnabled(!0), function(t) {
                            var e = W(t);
                            return e.Gr.delete(0 /* UserDisabled */), us(e);
                        }(n)) ];
                    }
                }));
            }));
                        ...
                        return i = o.sent(), [ 2 /*return*/ , (e.setNetworkEnabled(!1), function(t) {
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = W(t)).Gr.add(0 /* UserDisabled */), [ 4 /*yield*/ , as(e) ];
...
/** A "context" object passed around while parsing user data. */ var Xa = /** @class */ function() {
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.Oc = function(e) {
        ...
        var e, n = null === (e = this.path) || void 0 === e ? void 0 : e.child(t), r = this.Oc({
            path: n,
            Fc: !1
        });
        return r.Lc(t), r;
...
var rc = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        var e = new We(t.k, Fe(t.k, this.Gc));
 ...
 */ function hc(t, e) {
    ...
    return function(t, e) {
        ...
        if (t instanceof lt) {
            ...
            var r = new lt(t.seconds, 1e3 * Math.floor(t.nanoseconds / 1e3));
            return {
...
function mc(t, e, n, r, i) {
    ...
    a += ")"), new Y(H.INVALID_ARGUMENT, (u += ". ") + t + a)
...
/** Helper function to create a bound from a document or fields */ function Gc(t, e, n, r) {
    if (n[0] = I(n[0]), n[0] instanceof wc) return function(t, e, n, r, i) {
        ...
        // results.
        for (var o = [], s = 0, u = Ae(t); s < u.length; s++) {
            var a = u[s];
            if (a.field.isKeyField()) o.push(jt(e, r.key)); else {
                var c = r.data.field(a.field);
                if (Dt(c)) throw new Y(H.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + a.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === c) {
                    var h = a.field.canonicalString();
                    throw new Y(H.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a document for which the field '" + h + "' (used as the orderBy) does not exist.");
                }
                o.push(c);
            }
        }
    ...
    return function(t, e, n, r, i, o) {
        ...
        if (i.length > s.length) throw new Y(H.INVALID_ARGUMENT, "Too many arguments provided to " + r + "(). The number of arguments must be less than or equal to the number of orderBy() clauses");
 ...
 */ var Hc = /** @class */ function() {
    ...
    return t.prototype.convertValue = function(t, e) {
        ...
        var n = this, r = {};
        return yt(t.fields, (function(t, i) {
                        ...
                        return i = function(t, e, i) {
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(r) {
                                    switch (r.label) {
                                      case 0:
                                        return r.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , bo(t, e, 
                                        /* usePreviousResults= */ !0) ];
...
function hh(t) {
    ...
    return function(t, e, i, o) {
        ...
        return t.asyncQueue.enqueueAndForget((function() {
            ...
            u.nc(), t.asyncQueue.enqueueAndForget((function() {
                return n(s, void 0, void 0, (function() {
                    var e;
                    return r(this, (function(n) {
                        switch (n.label) {
...
function fh(t, e) {
    return function(t, e) {
        ...
        return t.asyncQueue.enqueueAndForget((function() {
            ...
            o.nc(), t.asyncQueue.enqueueAndForget((function() {
                return n(i, void 0, void 0, (function() {
                    var e;
                    return r(this, (function(n) {
                        switch (n.label) {
